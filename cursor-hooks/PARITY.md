# Feature Parity: UltraBrain Hooks vs Cursor Hooks

This document compares ultrabrain's Claude Code hooks with the Cursor hooks implementation to ensure feature parity.
...
**How it works**:
- Hook writes context to `.cursor/rules/ultrabrain-context.mdc`
...
### Tag Stripping
- **Claude Code**: Worker handles `<private>` and `<ultrabrain-context>` tags
...
**Overall**: The Cursor hooks implementation achieves **full functional parity** with ultrabrain's Claude Code hooks:
