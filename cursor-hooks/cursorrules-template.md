...
If you want to add custom instructions about ultrabrain (beyond the auto-injected context), create a separate rules file:

### `.cursor/rules/ultrabrain-instructions.mdc`

```markdown
---
alwaysApply: true
description: "Instructions for using ultrabrain memory system"
---

# Memory System Usage

You have access to ultrabrain, a persistent memory system. In addition to the auto-injected context above, you can search for more detailed information using MCP tools:
...
|------|---------|------------|
| `.cursor/rules/ultrabrain-context.mdc` | Auto-injected context | Hook (automatic) |
| `.cursor/rules/ultrabrain-instructions.mdc` | MCP tool instructions | You (optional) |
