...
//   "[Strategically Omitted by UltraBrain to save tokens]
//
...
// Configuration
const DB_PATH = path.join(homedir(), '.ultrabrain', 'ultrabrain.db');
const MAX_TRANSCRIPTS = parseInt(process.env.MAX_TRANSCRIPTS || '500', 10);

// Find transcript files (most recent first)
const TRANSCRIPT_DIR = path.join(homedir(), '.claude/projects/-Users-giulianofalco-Desktop-ultrabrain');
