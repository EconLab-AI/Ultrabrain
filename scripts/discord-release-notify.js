...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/EconLab-AI/Ultrabrain';

  const payload = {
    embeds: [
      {
        title: `🚀 ultrabrain ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.ultrabrain.ai](https://docs.ultrabrain.ai)',
            inline: true,
          },
        ],
        footer: {
          text: 'ultrabrain • Persistent memory for Claude Code',
        },
