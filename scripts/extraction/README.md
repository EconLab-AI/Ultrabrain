...
**Output:** `~/Desktop/ultrabrain/actual_xml_only_with_timestamps.xml`
...
**Output:** `~/Desktop/ultrabrain/all_xml_fragments_with_timestamps.xml`
...
Scripts read from: `~/.claude/projects/-Users-giulianofalco-Desktop-ultrabrain/*.jsonl`
