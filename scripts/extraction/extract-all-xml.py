...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-giulianofalco-Desktop-ultrabrain/')
...
output_file = os.path.expanduser('~/Desktop/ultrabrain/all_xml_fragments_with_timestamps.xml')
