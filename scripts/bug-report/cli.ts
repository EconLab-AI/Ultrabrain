...
function printHelp(): void {
  console.log(`
bug-report - Generate bug reports for ultrabrain
...
DESCRIPTION:
  ...
  and generates a formatted GitHub issue for ultrabrain using the Claude Agent SDK.
...
async function main() {
  ...
  console.log(`   UltraBrain: v${diagnostics.versions.claudeMem}`);
  ...
  const githubUrl = `https://github.com/EconLab-AI/Ultrabrain/issues/new?title=${encodedTitle}&body=${encodedBody}`;
