...
/**
 * Build script for ultrabrain hooks
...
async function buildHooks() {
  console.log('🔨 Building ultrabrain hooks and worker service...\n');
  ...
  try {
    ...
    const pluginPackageJson = {
      name: 'ultrabrain-plugin',
      version: version,
      private: true,
      description: 'Runtime dependencies for ultrabrain bundled hooks',
      type: 'module',
      dependencies: {},
      engines: {
        node: '>=18.0.0',
