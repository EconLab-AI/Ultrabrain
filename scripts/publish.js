...
async function publish() {
  try {
    console.log('📦 UltraBrain Marketplace Release Tool\n');
...
https://github.com/EconLab-AI/Ultrabrain"`);
    ...
    console.log(`\n🏷️  Tag: https://github.com/EconLab-AI/Ultrabrain/releases/tag/v${newVersion}`);
