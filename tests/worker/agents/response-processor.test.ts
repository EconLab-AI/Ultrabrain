...
describe('ResponseProcessor', () => {
  ...
  let mockLanceSyncObservation: ReturnType<typeof mock>;
  let mockLanceSyncSummary: ReturnType<typeof mock>;
  ...
  beforeEach(() => {
    ...
    mockLanceSyncObservation = mock(() => Promise.resolve());
    mockLanceSyncSummary = mock(() => Promise.resolve());
    ...
    mockDbManager = {
      ...
      getLanceSync: () => ({
        syncObservation: mockLanceSyncObservation,
        syncSummary: mockLanceSyncSummary,
      }),
