...
/**
 * Simple path configuration for ultrabrain
 * Standard paths based on Claude Code conventions
 */

// Base directories
export const DATA_DIR = SettingsDefaultsManager.get('ULTRABRAIN_DATA_DIR');
// Note: CLAUDE_CONFIG_DIR is a Claude Code setting, not ultrabrain, so leave as env var
export const CLAUDE_CONFIG_DIR = process.env.CLAUDE_CONFIG_DIR || join(homedir(), '.claude');

// Plugin installation directory - respects CLAUDE_CONFIG_DIR for users with custom Claude locations
export const MARKETPLACE_ROOT = join(CLAUDE_CONFIG_DIR, 'plugins', 'marketplaces', 'giulianofalco');
...
export const DB_PATH = join(DATA_DIR, 'ultrabrain.db');
