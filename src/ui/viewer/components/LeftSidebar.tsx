...
export type ViewType = 'feed' | 'projects' | 'kanban' | 'claude-desktop'
  ...
  | 'current-state' | 'claude-md' | 'loop' | 'teams' | 'terminal'
  | 'automation' | 'analytics' | 'graph';
    ...
    <>
      ...
      <nav className={`left-sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <div className="left-sidebar-nav">
          ...
          {/* 7. Ops Center */}
          <div className="left-sidebar-divider" />
          <div style={{ padding: '4px 16px 2px', fontSize: '10px', color: '#5a5a7a', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            Ops Center
          </div>

          <button
            className={`left-sidebar-item ${currentView === 'terminal' ? 'active' : ''}`}
            onClick={() => onViewChange('terminal')}
          >
            <span className="left-sidebar-item-icon">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="3" width="20" height="18" rx="2" /><polyline points="7 10 10 13 7 16" /><line x1="13" y1="16" x2="17" y2="16" />
              </svg>
            </span>
            <span className="left-sidebar-item-label">Terminal</span>
          </button>

          <button
            className={`left-sidebar-item ${currentView === 'automation' ? 'active' : ''}`}
          ...
          >
            ...
            <span className="left-sidebar-item-label">Automation</span>
          </button>

          <button
            className={`left-sidebar-item ${currentView === 'analytics' ? 'active' : ''}`}
          ...
          >
            ...
            <span className="left-sidebar-item-label">Analytics</span>
          </button>

          <button
            className={`left-sidebar-item ${currentView === 'graph' ? 'active' : ''}`}
          ...
          >
            ...
            <span className="left-sidebar-item-label">Knowledge Graph</span>
          </button>
        </div>
