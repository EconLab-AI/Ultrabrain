          ...
          <div className="settings-column">
            ...
            >
              ...
              >
                <input
                  ...
                  min="1"
                  max="200"
                  value={formState.ULTRABRAIN_CONTEXT_OBSERVATIONS || '50'}
                  onChange={(e) => updateSetting('ULTRABRAIN_CONTEXT_OBSERVATIONS', e.target.value)}
                />
              </FormField>
              <FormField
                label="Sessions"
              ...
              >
                <input
                  ...
                  min="1"
                  max="50"
                  value={formState.ULTRABRAIN_CONTEXT_SESSION_COUNT || '10'}
                  onChange={(e) => updateSetting('ULTRABRAIN_CONTEXT_SESSION_COUNT', e.target.value)}
                />
              </FormField>
            </CollapsibleSection>
            ...
            >
              <ChipGroup
                ...
                selectedValues={getArrayValues('ULTRABRAIN_CONTEXT_OBSERVATION_TYPES')}
                onToggle={(value) => toggleArrayValue('ULTRABRAIN_CONTEXT_OBSERVATION_TYPES', value)}
                onSelectAll={() => setAllArrayValues('ULTRABRAIN_CONTEXT_OBSERVATION_TYPES', observationTypes)}
                onSelectNone={() => setAllArrayValues('ULTRABRAIN_CONTEXT_OBSERVATION_TYPES', [])}
              />
              <ChipGroup
                label="Concept"
                options={observationConcepts}
                selectedValues={getArrayValues('ULTRABRAIN_CONTEXT_OBSERVATION_CONCEPTS')}
                onToggle={(value) => toggleArrayValue('ULTRABRAIN_CONTEXT_OBSERVATION_CONCEPTS', value)}
                onSelectAll={() => setAllArrayValues('ULTRABRAIN_CONTEXT_OBSERVATION_CONCEPTS', observationConcepts)}
                onSelectNone={() => setAllArrayValues('ULTRABRAIN_CONTEXT_OBSERVATION_CONCEPTS', [])}
              />
            </CollapsibleSection>
              ...
              <div className="display-subsection">
                ...
                >
                  <input
                    ...
                    min="0"
                    max="20"
                    value={formState.ULTRABRAIN_CONTEXT_FULL_COUNT || '5'}
                    onChange={(e) => updateSetting('ULTRABRAIN_CONTEXT_FULL_COUNT', e.target.value)}
                  />
                </FormField>
                <FormField
                  label="Field"
                ...
                >
                  <select
                    value={formState.ULTRABRAIN_CONTEXT_FULL_FIELD || 'narrative'}
                    onChange={(e) => updateSetting('ULTRABRAIN_CONTEXT_FULL_FIELD', e.target.value)}
                  >
              ...
              <div className="display-subsection">
                ...
                <div className="toggle-group">
                  <ToggleSwitch
                    ...
                    checked={formState.ULTRABRAIN_CONTEXT_SHOW_READ_TOKENS === 'true'}
                    onChange={() => toggleBoolean('ULTRABRAIN_CONTEXT_SHOW_READ_TOKENS')}
                  />
                  <ToggleSwitch
                    id="show-work-tokens"
                    label="Work investment"
                    description="Tokens spent creating this observation"
                    checked={formState.ULTRABRAIN_CONTEXT_SHOW_WORK_TOKENS === 'true'}
                    onChange={() => toggleBoolean('ULTRABRAIN_CONTEXT_SHOW_WORK_TOKENS')}
                  />
                  <ToggleSwitch
                    id="show-savings-amount"
                    label="Savings"
                    description="Total tokens saved by reusing context"
                    checked={formState.ULTRABRAIN_CONTEXT_SHOW_SAVINGS_AMOUNT === 'true'}
                    onChange={() => toggleBoolean('ULTRABRAIN_CONTEXT_SHOW_SAVINGS_AMOUNT')}
                  />
                </div>
              </div>
            </CollapsibleSection>
            ...
            >
              ...
              >
                <select
                  value={formState.ULTRABRAIN_PROVIDER || 'claude'}
                  onChange={(e) => updateSetting('ULTRABRAIN_PROVIDER', e.target.value)}
                >
              ...
              {formState.ULTRABRAIN_PROVIDER === 'gemini' && (
                <>
                  ...
                  >
                    <input
                      type="password"
                      value={formState.ULTRABRAIN_GEMINI_API_KEY || ''}
                      onChange={(e) => updateSetting('ULTRABRAIN_GEMINI_API_KEY', e.target.value)}
                  ...
                  >
                    <select
                      value={formState.ULTRABRAIN_GEMINI_MODEL || 'gemini-2.5-flash-lite'}
                      onChange={(e) => updateSetting('ULTRABRAIN_GEMINI_MODEL', e.target.value)}
                    >
                  ...
                  <div className="toggle-group" style={{ marginTop: '8px' }}>
                    <ToggleSwitch
                      ...
                      checked={formState.ULTRABRAIN_GEMINI_RATE_LIMITING_ENABLED === 'true'}
                      onChange={(checked) => updateSetting('ULTRABRAIN_GEMINI_RATE_LIMITING_ENABLED', checked ? 'true' : 'false')}
                    />
                  </div>
                </>
              )}
              ...
              {formState.ULTRABRAIN_PROVIDER === 'openrouter' && (
                <>
                  ...
                  >
                    <input
                      type="password"
                      value={formState.ULTRABRAIN_OPENROUTER_API_KEY || ''}
                      onChange={(e) => updateSetting('ULTRABRAIN_OPENROUTER_API_KEY', e.target.value)}
                  ...
                  >
                    <input
                      type="text"
                      value={formState.ULTRABRAIN_OPENROUTER_SITE_URL || ''}
                      onChange={(e) => updateSetting('ULTRABRAIN_OPENROUTER_SITE_URL', e.target.value)}
                  ...
                  >
                    <input
                      type="text"
                      value={formState.ULTRABRAIN_OPENROUTER_APP_NAME || 'ultrabrain'}
                      onChange={(e) => updateSetting('ULTRABRAIN_OPENROUTER_APP_NAME', e.target.value)}
                      placeholder="ultrabrain"
                    />
                  </FormField>
                </>
              )}
              ...
              >
                <input
                  ...
                  min="1024"
                  max="65535"
                  value={formState.ULTRABRAIN_WORKER_PORT || '37777'}
                  onChange={(e) => updateSetting('ULTRABRAIN_WORKER_PORT', e.target.value)}
                />
              </FormField>
              ...
              <div className="toggle-group" style={{ marginTop: '12px' }}>
                <ToggleSwitch
                  ...
                  checked={formState.ULTRABRAIN_CONTEXT_SHOW_LAST_SUMMARY === 'true'}
                  onChange={() => toggleBoolean('ULTRABRAIN_CONTEXT_SHOW_LAST_SUMMARY')}
                />
                <ToggleSwitch
                  id="show-last-message"
                  label="Include last message"
                  description="Add previous session's final message"
                  checked={formState.ULTRABRAIN_CONTEXT_SHOW_LAST_MESSAGE === 'true'}
                  onChange={() => toggleBoolean('ULTRABRAIN_CONTEXT_SHOW_LAST_MESSAGE')}
                />
              </div>
            </CollapsibleSection>
          </div>
