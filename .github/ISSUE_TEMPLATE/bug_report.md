...
- [ ] I searched [existing issues](https://github.com/EconLab-AI/Ultrabrain/issues) and confirmed this is not a duplicate
...
**Plugin Paths:**
- **macOS/Linux**: `~/.claude/plugins/marketplaces/giulianofalco`
- **Windows**: `%USERPROFILE%\.claude\plugins\marketplaces\giulianofalco`
...
- **Path**: `~/.ultrabrain/logs/worker-YYYY-MM-DD.log`
- **Example**: `~/.ultrabrain/logs/worker-2025-12-14.log`
