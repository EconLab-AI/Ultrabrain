...
description: "Learn how UltraBrain works automatically in the background"
---

# Getting Started with UltraBrain

## Automatic Operation

UltraBrain works automatically once installed. No manual intervention required!
...
Every time Claude uses a tool, ultrabrain captures it:
...
Context is stored in SQLite database at `~/.ultrabrain/ultrabrain.db`.
...
UltraBrain supports sessions that span multiple user prompts:
...
UltraBrain provides MCP tools for querying your project history. Simply ask naturally:
