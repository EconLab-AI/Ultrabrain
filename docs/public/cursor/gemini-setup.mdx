...
description: "Use UltraBrain in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up UltraBrain in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
## Step 2: Clone and Build UltraBrain
...
{
  "ULTRABRAIN_PROVIDER": "gemini",
  "ULTRABRAIN_GEMINI_API_KEY": "your-key",
  "ULTRABRAIN_GEMINI_MODEL": "gemini-2.5-flash"
}
```

## Rate Limiting

UltraBrain automatically handles rate limiting for free tier usage:
...
{
  "ULTRABRAIN_PROVIDER": "gemini",
  "ULTRABRAIN_GEMINI_API_KEY": "AIza..."
}
```
