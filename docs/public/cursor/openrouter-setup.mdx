...
description: "Use UltraBrain in Cursor with OpenRouter's 100+ AI models"
---

# Cursor + OpenRouter Setup

This guide walks you through setting up UltraBrain in Cursor using OpenRouter. OpenRouter provides access to 100+ AI models from various providers, including several free options.
...
{
  "ULTRABRAIN_PROVIDER": "openrouter",
  "ULTRABRAIN_OPENROUTER_API_KEY": "your-key",
  "ULTRABRAIN_OPENROUTER_MODEL": "google/gemini-2.0-flash-exp:free"
}
```
...
{
  "ULTRABRAIN_PROVIDER": "openrouter",
  "ULTRABRAIN_OPENROUTER_API_KEY": "sk-or-..."
}
```
