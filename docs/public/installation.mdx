---
title: "Installation"
description: "Install UltraBrain plugin for persistent memory across sessions"
---
...
Install UltraBrain directly from the plugin marketplace:
...
Data is stored in `~/.ultrabrain/`:
- Database: `~/.ultrabrain/ultrabrain.db`
- PID file: `~/.ultrabrain/.worker.pid`
- Port file: `~/.ultrabrain/.worker.port`
- Logs: `~/.ultrabrain/logs/worker-YYYY-MM-DD.log`
- Settings: `~/.ultrabrain/settings.json`

Override with environment variable:
```bash
export ULTRABRAIN_DATA_DIR=/custom/path
```
...
See [CHANGELOG](https://github.com/EconLab-AI/Ultrabrain/blob/main/CHANGELOG.md) for complete version history.

## Next Steps

- [Getting Started Guide](usage/getting-started) - Learn how UltraBrain works automatically
- [MCP Search Tools](usage/search-tools) - Query your project history
- [Configuration](configuration) - Customize UltraBrain behavior
