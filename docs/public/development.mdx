---
title: "Development"
description: "Build from source, run tests, and contribute to UltraBrain"
---
...
UltraBrain relies on **real-world usage and manual testing** rather than traditional unit tests. The project philosophy prioritizes:
...
3. **Check database state**:
   ```bash
   sqlite3 ~/.ultrabrain/ultrabrain.db "SELECT * FROM your_table;"
   ```
