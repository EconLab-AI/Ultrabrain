...
description: "System components and data flow in UltraBrain"
---
...
UltraBrain operates as a Claude Code plugin with five core components:
...
4. **Database Layer** - Store sessions and observations (SQLite + FTS5 + LanceDB)
...
| **Vector Store**       | LanceDB (optional, for semantic search)  |
...
- Location: `~/.ultrabrain/ultrabrain.db`
