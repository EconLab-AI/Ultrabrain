...
UltraBrain implements a **5-stage hook system** that captures development work across Claude Code sessions. This document provides a complete technical reference for developers implementing this pattern on other platforms.
...
// Removes <private>...</private> and <ultrabrain-context>...</ultrabrain-context>
...
sequenceDiagram
    ...
    alt Tool in skip list
        ...
        Agent->>DB: Sync to Lance vector DB
    end
...
sequenceDiagram
    ...
    Agent->>DB: Sync to Lance (for semantic search)
...
<ultrabrain-context>...</ultrabrain-context>
```
