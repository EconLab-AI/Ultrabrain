...
<p align="center">
  UltraBrain säilyttää kontekstin saumattomasti istuntojen välillä tallentamalla automaattisesti työkalujen käyttöhavaintoja, luomalla semanttisia yhteenvetoja ja asettamalla ne tulevien istuntojen saataville. Tämä mahdollistaa Clauden säilyttää tiedon jatkuvuuden projekteista senkin jälkeen, kun istunnot päättyvät tai yhteys palautuu.
</p>
...
📚 **[Näytä täydellinen dokumentaatio](https://docs.ultrabrain.ai/)** - Selaa virallisella verkkosivustolla

### Aloitus

- **[Asennusopas](https://docs.ultrabrain.ai/installation)** - Pikaopas ja edistynyt asennus
- **[Käyttöopas](https://docs.ultrabrain.ai/usage/getting-started)** - Miten UltraBrain toimii automaattisesti
- **[Hakutyökalut](https://docs.ultrabrain.ai/usage/search-tools)** - Kysy projektihistoriaasi luonnollisella kielellä
- **[Beta-ominaisuudet](https://docs.ultrabrain.ai/beta-features)** - Kokeile kokeellisia ominaisuuksia kuten Endless Mode

### Parhaat käytännöt

- **[Kontekstisuunnittelu](https://docs.ultrabrain.ai/context-engineering)** - AI-agentin kontekstin optimointiperiaatteet
- **[Asteittainen paljastaminen](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofia UltraBrain-kontekstin valmistelustrategian takana

### Arkkitehtuuri

- **[Yleiskatsaus](https://docs.ultrabrain.ai/architecture/overview)** - Järjestelmän komponentit ja datavirta
- **[Arkkitehtuurin kehitys](https://docs.ultrabrain.ai/architecture-evolution)** - Matka versiosta v3 versioon v5
- **[Koukku-arkkitehtuuri](https://docs.ultrabrain.ai/hooks-architecture)** - Miten UltraBrain käyttää elinkaarikkoukkuja
- **[Koukku-viittaus](https://docs.ultrabrain.ai/architecture/hooks)** - 7 koukku-skriptiä selitettynä
- **[Worker-palvelu](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API ja Bun-hallinta
- **[Tietokanta](https://docs.ultrabrain.ai/architecture/database)** - SQLite-skeema ja FTS5-haku
- **[Hakuarkkitehtuuri](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybridihaku Chroma-vektoritietokannalla

### Asetukset ja kehitys

- **[Asetukset](https://docs.ultrabrain.ai/configuration)** - Ympäristömuuttujat ja asetukset
- **[Kehitys](https://docs.ultrabrain.ai/development)** - Rakentaminen, testaus, osallistuminen
- **[Vianmääritys](https://docs.ultrabrain.ai/troubleshooting)** - Yleiset ongelmat ja ratkaisut
...
Katso [Arkkitehtuurin yleiskatsaus](https://docs.ultrabrain.ai/architecture/overview) yksityiskohdista.

---

## mem-search-taito

UltraBrain tarjoaa älykkään haun mem-search-taidon kautta, joka käynnistyy automaattisesti kun kysyt aiemmasta työstä:
...
Katso [Hakutyökalujen opas](https://docs.ultrabrain.ai/usage/search-tools) yksityiskohtaisia esimerkkejä varten.

---

## Beta-ominaisuudet

UltraBrain tarjoaa **beta-kanavan** kokeellisilla ominaisuuksilla kuten **Endless Mode** (biomimeettinen muistiarkkitehtuuri pidennetyille istunnoille). Vaihda vakaan ja beta-version välillä web-katselukäyttöliittymästä osoitteessa http://localhost:37777 → Settings.

Katso **[Beta-ominaisuuksien dokumentaatio](https://docs.ultrabrain.ai/beta-features)** yksityiskohdista Endless Moden ja sen kokeilemisen osalta.
...
Asetuksia hallitaan tiedostossa `~/.ultrabrain/settings.json` (luodaan automaattisesti oletusarvoilla ensimmäisellä suorituskerralla). Määritä AI-malli, worker-portti, datahakemisto, lokitaso ja kontekstin injektointiasetukset.

Katso **[Asetusopas](https://docs.ultrabrain.ai/configuration)** kaikista saatavilla olevista asetuksista ja esimerkeistä.

---

## Kehitys

Katso **[Kehitysopas](https://docs.ultrabrain.ai/development)** rakennusohjeista, testauksesta ja osallistumisen työnkulusta.
...
Katso **[Vianmääritysopas](https://docs.ultrabrain.ai/troubleshooting)** yleisistä ongelmista ja ratkaisuista.
...
Katso [Kehitysopas](https://docs.ultrabrain.ai/development) osallistumisen työnkulusta.
...
- **Ongelmat**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repositorio**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Tekijä**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
