...
<p align="center">
  UltraBrain משמר הקשר בצורה חלקה בין הפעלות על ידי לכידה אוטומטית של תצפיות על שימוש בכלים, יצירת סיכומים סמנטיים, והנגשתם להפעלות עתידיות. זה מאפשר ל-Claude לשמור על המשכיות של ידע על פרויקטים גם לאחר שהפעלות מסתיימות או מתחברות מחדש.
</p>
...
📚 **[צפה בתיעוד המלא](https://docs.ultrabrain.ai/)** - דפדף באתר הרשמי

### תחילת העבודה

- **[מדריך התקנה](https://docs.ultrabrain.ai/installation)** - התחלה מהירה והתקנה מתקדמת
- **[מדריך שימוש](https://docs.ultrabrain.ai/usage/getting-started)** - איך UltraBrain עובד אוטומטית
- **[כלי חיפוש](https://docs.ultrabrain.ai/usage/search-tools)** - שאל את היסטוריית הפרויקט שלך בשפה טבעית
- **[תכונות בטא](https://docs.ultrabrain.ai/beta-features)** - נסה תכונות ניסיוניות כמו Endless Mode

### שיטות מומלצות

- **[הנדסת הקשר](https://docs.ultrabrain.ai/context-engineering)** - עקרונות אופטימיזציה של הקשר לסוכן AI
- **[גילוי מדורג](https://docs.ultrabrain.ai/progressive-disclosure)** - הפילוסופיה מאחורי אסטרטגיית הכנת ההקשר של UltraBrain

### ארכיטקטורה

- **[סקירה כללית](https://docs.ultrabrain.ai/architecture/overview)** - רכיבי המערכת וזרימת הנתונים
- **[התפתחות הארכיטקטורה](https://docs.ultrabrain.ai/architecture-evolution)** - המסע מגרסה 3 לגרסה 5
- **[ארכיטקטורת Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - איך UltraBrain משתמש ב-lifecycle hooks
- **[מדריך Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - 7 סקריפטי hook מוסברים
- **[שירות Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API וניהול Bun
- **[מסד נתונים](https://docs.ultrabrain.ai/architecture/database)** - סכמת SQLite וחיפוש FTS5
- **[ארכיטקטורת חיפוש](https://docs.ultrabrain.ai/architecture/search-architecture)** - חיפוש היברידי עם מסד נתוני וקטורים Chroma

### הגדרות ופיתוח

- **[הגדרות](https://docs.ultrabrain.ai/configuration)** - משתני סביבה והגדרות
- **[פיתוח](https://docs.ultrabrain.ai/development)** - בנייה, בדיקה, תרומה
- **[פתרון בעיות](https://docs.ultrabrain.ai/troubleshooting)** - בעיות נפוצות ופתרונות
...
ראה [סקירה כללית של הארכיטקטורה](https://docs.ultrabrain.ai/architecture/overview) לפרטים.

---

## מיומנות mem-search

UltraBrain מספק חיפוש חכם דרך מיומנות mem-search שמופעלת אוטומטית כשאתה שואל על עבודה קודמת:
...
ראה [מדריך כלי חיפוש](https://docs.ultrabrain.ai/usage/search-tools) לדוגמאות מפורטות.

---

## תכונות בטא

UltraBrain מציע **ערוץ בטא** עם תכונות ניסיוניות כמו **Endless Mode** (ארכיטקטורת זיכרון ביומימטית להפעלות מורחבות). החלף בין גרסאות יציבות ובטא מממשק הצופה האינטרנט ב-http://localhost:37777 → Settings.

ראה **[תיעוד תכונות בטא](https://docs.ultrabrain.ai/beta-features)** לפרטים על Endless Mode ואיך לנסות אותו.
...
ההגדרות מנוהלות ב-`~/.ultrabrain/settings.json` (נוצר אוטומטית עם ברירות מחדל בהפעלה הראשונה). הגדר מודל AI, פורט worker, ספריית נתונים, רמת לוג, והגדרות הזרקת הקשר.

ראה **[מדריך הגדרות](https://docs.ultrabrain.ai/configuration)** לכל ההגדרות הזמינות ודוגמאות.

---

## פיתוח

ראה **[מדריך פיתוח](https://docs.ultrabrain.ai/development)** להוראות בנייה, בדיקה, ותהליך תרומה.
...
ראה **[מדריך פתרון בעיות](https://docs.ultrabrain.ai/troubleshooting)** לבעיות נפוצות ופתרונות.
...
ראה [מדריך פיתוח](https://docs.ultrabrain.ai/development) לתהליך תרומה.
...
- **תיעוד**: [docs/](docs/)
- **בעיות**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **מאגר**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **מחבר**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
