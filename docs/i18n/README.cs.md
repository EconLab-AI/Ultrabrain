...
<p align="center">
  UltraBrain bezproblémově zachovává kontext napříč sezeními tím, že automaticky zaznamenává pozorování použití nástrojů, generuje sémantické souhrny a zpřístupňuje je budoucím sezením. To umožňuje Claude udržovat kontinuitu znalostí o projektech i po ukončení nebo opětovném připojení sezení.
</p>
...
📚 **[Zobrazit kompletní dokumentaci](https://docs.ultrabrain.ai/)** - Procházet na oficiálních stránkách

### Začínáme

- **[Průvodce instalací](https://docs.ultrabrain.ai/installation)** - Rychlý start a pokročilá instalace
- **[Průvodce použitím](https://docs.ultrabrain.ai/usage/getting-started)** - Jak UltraBrain funguje automaticky
- **[Vyhledávací nástroje](https://docs.ultrabrain.ai/usage/search-tools)** - Dotazujte se na historii projektu pomocí přirozeného jazyka
- **[Beta funkce](https://docs.ultrabrain.ai/beta-features)** - Vyzkoušejte experimentální funkce jako Endless Mode

### Osvědčené postupy

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - Principy optimalizace kontextu AI agenta
- **[Postupné odhalování](https://docs.ultrabrain.ai/progressive-disclosure)** - Filozofie strategie přípravy kontextu UltraBrain

### Architektura

- **[Přehled](https://docs.ultrabrain.ai/architecture/overview)** - Systémové komponenty a tok dat
- **[Evoluce architektury](https://docs.ultrabrain.ai/architecture-evolution)** - Cesta z v3 na v5
- **[Architektura háčků](https://docs.ultrabrain.ai/hooks-architecture)** - Jak UltraBrain používá lifecycle hooks
- **[Reference háčků](https://docs.ultrabrain.ai/architecture/hooks)** - Vysvětlení 7 hook skriptů
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API a správa Bun
- **[Databáze](https://docs.ultrabrain.ai/architecture/database)** - SQLite schéma a FTS5 vyhledávání
- **[Architektura vyhledávání](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybridní vyhledávání s vektorovou databází Chroma

### Konfigurace a vývoj

- **[Konfigurace](https://docs.ultrabrain.ai/configuration)** - Proměnné prostředí a nastavení
- **[Vývoj](https://docs.ultrabrain.ai/development)** - Sestavení, testování, přispívání
- **[Řešení problémů](https://docs.ultrabrain.ai/troubleshooting)** - Běžné problémy a řešení
...
6. **Lance vektorová databáze** - Hybridní sémantické + klíčové vyhledávání pro inteligentní vyhledávání kontextu

Podrobnosti najdete v [Přehledu architektury](https://docs.ultrabrain.ai/architecture/overview).

---

## Dovednost mem-search

UltraBrain poskytuje inteligentní vyhledávání prostřednictvím dovednosti mem-search, která se automaticky vyvolá, když se ptáte na minulou práci:
...
Podrobné příklady najdete v [Průvodci vyhledávacími nástroji](https://docs.ultrabrain.ai/usage/search-tools).

---

## Beta funkce

UltraBrain nabízí **beta kanál** s experimentálními funkcemi jako **Endless Mode** (biomimetická architektura paměti pro prodloužená sezení). Přepínejte mezi stabilní a beta verzí z webového rozhraní na http://localhost:37777 → Settings.

Podrobnosti o Endless Mode a jak jej vyzkoušet najdete v **[Dokumentaci beta funkcí](https://docs.ultrabrain.ai/beta-features)**.
...
Nastavení jsou spravována v `~/.ultrabrain/settings.json` (automaticky vytvořeno s výchozími hodnotami při prvním spuštění). Konfigurujte AI model, port workeru, datový adresář, úroveň logování a nastavení vkládání kontextu.

Všechna dostupná nastavení a příklady najdete v **[Průvodci konfigurací](https://docs.ultrabrain.ai/configuration)**.

---

## Vývoj

Podrobné pokyny k sestavení, testování a pracovnímu postupu pro přispívání najdete v **[Průvodci vývojem](https://docs.ultrabrain.ai/development)**.
...
Běžné problémy a řešení najdete v **[Průvodci řešením problémů](https://docs.ultrabrain.ai/troubleshooting)**.
...
Pracovní postup pro přispívání najdete v [Průvodci vývojem](https://docs.ultrabrain.ai/development).
...
- **Problémy**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repositář**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
