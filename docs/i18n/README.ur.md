...
<p align="center">
  UltraBrain خودکار طور پر ٹول کے استعمال کے بعد کے مشاہدات کو ریکارڈ کرتا ہے، سیمانٹک خلاصے تیار کرتا ہے اور انہیں مستقبل کے سیشنز میں دستیاب کرتا ہے تاکہ آپ سیشن میں براہ راست تناسب محفوظ رہے۔ یہ Claude کو سیشن ختم ہونے یا دوبارہ جڑنے کے بعد بھی منصوبے کے بارے میں معلومات کی مسلسلیت برقرار رکھنے کے قابل بناتا ہے۔
</p>
...
- **[انسٹالیشن گائیڈ](https://docs.ultrabrain.ai/installation)** - تیز رفتار شروعات اور اعلیٰ درجے کی انسٹالیشن
- **[استعمال گائیڈ](https://docs.ultrabrain.ai/usage/getting-started)** - UltraBrain خودکار طور پر کیسے کام کرتا ہے
- **[تلاش کے اوزار](https://docs.ultrabrain.ai/usage/search-tools)** - قدرتی زبان کے ساتھ اپنے منصوبے کی تاریخ میں تلاش کریں
- **[بیٹا خصوصیات](https://docs.ultrabrain.ai/beta-features)** - Endless Mode جیسی تجرباتی خصوصیات آزمائیں

### بہترین طریقہ کار

- **[تناسب انجینیئرنگ](https://docs.ultrabrain.ai/context-engineering)** - AI ایجنٹ کے تناسب کی اہمیت کے اصول
- **[بتدریج ظہور](https://docs.ultrabrain.ai/progressive-disclosure)** - UltraBrain کے تناسب کی تیاری کی حکمت عملی کے پیچھے فلسفہ

### تعمیر

- **[جائزہ](https://docs.ultrabrain.ai/architecture/overview)** - نظام کے اجزاء اور ڈیٹا کے بہاؤ
- **[تعمیر کا ارتقاء](https://docs.ultrabrain.ai/architecture-evolution)** - v3 سے v5 تک کا سفر
- **[ہکس تعمیر](https://docs.ultrabrain.ai/hooks-architecture)** - UltraBrain لائف سائیکل ہکس کا استعمال کیسے کرتا ہے
- **[ہکس حوالہ](https://docs.ultrabrain.ai/architecture/hooks)** - 7 ہک اسکرپٹس کی تشریح
- **[ورکر سروس](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API اور Bun انتظام
- **[ڈیٹا بیس](https://docs.ultrabrain.ai/architecture/database)** - SQLite اسکیما اور FTS5 تلاش
- **[تلاش تعمیر](https://docs.ultrabrain.ai/architecture/search-architecture)** - Lance ویکٹر ڈیٹا بیس کے ساتھ ہائبرڈ تلاش

### ترتیبات اور ترقی

- **[ترتیبات](https://docs.ultrabrain.ai/configuration)** - ماحول کے متغیرات اور سیٹنگز
- **[ترقی](https://docs.ultrabrain.ai/development)** - تعمیر، جانچ، حصہ داری
- **[مسائل کی تشخیص](https://docs.ultrabrain.ai/troubleshooting)** - عام مسائل اور حل
...
6. **Lance ویکٹر ڈیٹا بیس** - ہائبرڈ سیمانٹک + کلیدی لفظ تلاش ذہین تناسب کی بازیافت کے لیے

تفصیلات کے لیے [تعمیر کا جائزہ](https://docs.ultrabrain.ai/architecture/overview) دیکھیں۔

---

## MCP تلاش کے اوزار

UltraBrain ٹوکن-موثر **3-لیئر ورک فلو پیٹرن** کی پیروی کرتے ہوئے **4 MCP اوزار** کے ذریعے ذہین میموری تلاش فراہم کرتا ہے:
...
تفصیلی مثالوں کے لیے [تلاش کے اوزار گائیڈ](https://docs.ultrabrain.ai/usage/search-tools) دیکھیں۔

---

## بیٹا خصوصیات

UltraBrain ایک **بیٹا چینل** فراہم کرتا ہے جس میں **Endless Mode** جیسی تجرباتی خصوصیات ہیں (بڑھی ہوئی سیشنز کے لیے حیاتی نقل میموری کی تعمیر)۔ http://localhost:37777 → Settings میں ویب ویور UI سے مستحکم اور بیٹا ورژن کے درمیان سوئچ کریں۔

Endless Mode اور اسے کیسے آزمائیں اس کے بارے میں تفصیلات کے لیے **[بیٹا خصوصیات دستاویزات](https://docs.ultrabrain.ai/beta-features)** دیکھیں۔
...
سیٹنگز `~/.ultrabrain/settings.json` میں منظم ہیں (پہلی رن میں ڈیفالٹ کے ساتھ خودکار طور پر بنائی جاتی ہے)۔ AI ماڈل، ورکر پورٹ، ڈیٹا ڈائریکٹری، لاگ لیول اور تناسب انجیکشن سیٹنگز کو ترتیب دیں۔

تمام دستیاب سیٹنگز اور مثالوں کے لیے **[ترتیبات گائیڈ](https://docs.ultrabrain.ai/configuration)** دیکھیں۔

---

## ترقی

تعمیر کی ہدایات، جانچ اور حصہ داری کے کام کے بہاؤ کے لیے **[ترقی گائیڈ](https://docs.ultrabrain.ai/development)** دیکھیں۔
...
عام مسائل اور حل کے لیے **[مسائل کی تشخیص گائیڈ](https://docs.ultrabrain.ai/troubleshooting)** دیکھیں۔
...
حصہ داری کے کام کے بہاؤ کے لیے [ترقی گائیڈ](https://docs.ultrabrain.ai/development) دیکھیں۔

---

## لائسنس

یہ منصوبہ **MIT License** (MIT) کے تحت لائسنس ہے۔

Copyright (c) 2026 Giuliano Falco (@giulianofalco)۔ تمام حقوق محفوظ ہیں۔
...
- ماخوذ کام بھی MIT کے تحت لائسنس ہونے چاہیں
...
- **دستاویزات**: [docs/](docs/)
- **مسائل**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **رپوزیٹری**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **مصنف**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
