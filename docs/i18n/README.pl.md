...
<p align="center">
  UltraBrain płynnie zachowuje kontekst między sesjami, automatycznie przechwytując obserwacje użycia narzędzi, generując semantyczne podsumowania i udostępniając je przyszłym sesjom. To umożliwia Claude utrzymanie ciągłości wiedzy o projektach nawet po zakończeniu lub ponownym połączeniu sesji.
</p>
...
📚 **[Wyświetl Pełną Dokumentację](https://docs.ultrabrain.ai/)** - Przeglądaj na oficjalnej stronie

### Pierwsze Kroki

- **[Przewodnik Instalacji](https://docs.ultrabrain.ai/installation)** - Szybki start i zaawansowana instalacja
- **[Przewodnik Użytkowania](https://docs.ultrabrain.ai/usage/getting-started)** - Jak UltraBrain działa automatycznie
- **[Narzędzia Wyszukiwania](https://docs.ultrabrain.ai/usage/search-tools)** - Przeszukuj historię projektu w języku naturalnym
- **[Funkcje Beta](https://docs.ultrabrain.ai/beta-features)** - Wypróbuj eksperymentalne funkcje, takie jak Endless Mode

### Najlepsze Praktyki

- **[Inżynieria Kontekstu](https://docs.ultrabrain.ai/context-engineering)** - Zasady optymalizacji kontekstu agenta AI
- **[Stopniowe Ujawnianie](https://docs.ultrabrain.ai/progressive-disclosure)** - Filozofia strategii przygotowania kontekstu UltraBrain

### Architektura

- **[Przegląd](https://docs.ultrabrain.ai/architecture/overview)** - Komponenty systemu i przepływ danych
- **[Ewolucja Architektury](https://docs.ultrabrain.ai/architecture-evolution)** - Droga od v3 do v5
- **[Architektura Hooków](https://docs.ultrabrain.ai/hooks-architecture)** - Jak UltraBrain wykorzystuje hooki cyklu życia
- **[Dokumentacja Hooków](https://docs.ultrabrain.ai/architecture/hooks)** - 7 skryptów hooków wyjaśnionych
- **[Usługa Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API i zarządzanie Bun
- **[Baza Danych](https://docs.ultrabrain.ai/architecture/database)** - Schemat SQLite i wyszukiwanie FTS5
- **[Architektura Wyszukiwania](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybrydowe wyszukiwanie z bazą wektorów Chroma

### Konfiguracja i Rozwój

- **[Konfiguracja](https://docs.ultrabrain.ai/configuration)** - Zmienne środowiskowe i ustawienia
- **[Rozwój](https://docs.ultrabrain.ai/development)** - Budowanie, testowanie, współpraca
- **[Rozwiązywanie Problemów](https://docs.ultrabrain.ai/troubleshooting)** - Typowe problemy i rozwiązania
...
Zobacz [Przegląd Architektury](https://docs.ultrabrain.ai/architecture/overview) dla szczegółów.

---

## Umiejętność mem-search

UltraBrain zapewnia inteligentne wyszukiwanie poprzez umiejętność mem-search, która automatycznie aktywuje się, gdy pytasz o przeszłą pracę:
...
Zobacz [Przewodnik Narzędzi Wyszukiwania](https://docs.ultrabrain.ai/usage/search-tools) dla szczegółowych przykładów.

---

## Funkcje Beta

UltraBrain oferuje **kanał beta** z eksperymentalnymi funkcjami, takimi jak **Endless Mode** (biomimetyczna architektura pamięci dla rozszerzonych sesji). Przełączaj się między stabilnymi a beta wersjami z interfejsu przeglądarki internetowej pod adresem http://localhost:37777 → Settings.

Zobacz **[Dokumentacja Funkcji Beta](https://docs.ultrabrain.ai/beta-features)** dla szczegółów dotyczących Endless Mode i sposobu wypróbowania.
...
Ustawienia są zarządzane w `~/.ultrabrain/settings.json` (automatycznie tworzone z domyślnymi wartościami przy pierwszym uruchomieniu). Skonfiguruj model AI, port workera, katalog danych, poziom logowania i ustawienia wstrzykiwania kontekstu.

Zobacz **[Przewodnik Konfiguracji](https://docs.ultrabrain.ai/configuration)** dla wszystkich dostępnych ustawień i przykładów.

---

## Rozwój

Zobacz **[Przewodnik Rozwoju](https://docs.ultrabrain.ai/development)** dla instrukcji budowania, testowania i przepływu pracy współpracy.
...
Zobacz **[Przewodnik Rozwiązywania Problemów](https://docs.ultrabrain.ai/troubleshooting)** dla typowych problemów i rozwiązań.
...
Zobacz [Przewodnik Rozwoju](https://docs.ultrabrain.ai/development) dla przepływu pracy współpracy.

---

## Licencja

Ten projekt jest licencjonowany na podstawie **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Wszelkie prawa zastrzeżone.
...
- Dzieła pochodne muszą być również licencjonowane na podstawie MIT
...
- **Problemy**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repozytorium**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Autor**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
