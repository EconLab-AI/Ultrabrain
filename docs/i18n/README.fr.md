...
📚 **[Voir la documentation complète](https://docs.ultrabrain.ai/)** - Parcourir sur le site officiel

### Pour commencer

- **[Guide d'installation](https://docs.ultrabrain.ai/installation)** - Démarrage rapide et installation avancée
- **[Guide d'utilisation](https://docs.ultrabrain.ai/usage/getting-started)** - Comment UltraBrain fonctionne automatiquement
- **[Outils de recherche](https://docs.ultrabrain.ai/usage/search-tools)** - Interrogez l'historique de votre projet en langage naturel
- **[Fonctionnalités bêta](https://docs.ultrabrain.ai/beta-features)** - Essayez des fonctionnalités expérimentales comme le mode Endless

### Bonnes pratiques

- **[Ingénierie du contexte](https://docs.ultrabrain.ai/context-engineering)** - Principes d'optimisation du contexte pour les agents IA
- **[Divulgation progressive](https://docs.ultrabrain.ai/progressive-disclosure)** - Philosophie derrière la stratégie d'amorçage du contexte de UltraBrain

### Architecture

- **[Vue d'ensemble](https://docs.ultrabrain.ai/architecture/overview)** - Composants du système et flux de données
- **[Évolution de l'architecture](https://docs.ultrabrain.ai/architecture-evolution)** - Le parcours de la v3 à la v5
- **[Architecture des hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Comment UltraBrain utilise les hooks de cycle de vie
- **[Référence des hooks](https://docs.ultrabrain.ai/architecture/hooks)** - Explication des 7 scripts de hooks
- **[Service Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - API HTTP et gestion Bun
- **[Base de données](https://docs.ultrabrain.ai/architecture/database)** - Schéma SQLite et recherche FTS5
- **[Architecture de recherche](https://docs.ultrabrain.ai/architecture/search-architecture)** - Recherche hybride avec la base de données vectorielle Chroma

### Configuration et développement

- **[Configuration](https://docs.ultrabrain.ai/configuration)** - Variables d'environnement et paramètres
- **[Développement](https://docs.ultrabrain.ai/development)** - Compilation, tests, contribution
- **[Dépannage](https://docs.ultrabrain.ai/troubleshooting)** - Problèmes courants et solutions
...
Voir [Vue d'ensemble de l'architecture](https://docs.ultrabrain.ai/architecture/overview) pour plus de détails.

---

## Compétence mem-search

UltraBrain fournit une recherche intelligente via la compétence mem-search qui s'invoque automatiquement lorsque vous posez des questions sur le travail passé :
...
Voir le [Guide des outils de recherche](https://docs.ultrabrain.ai/usage/search-tools) pour des exemples détaillés.

---

## Fonctionnalités bêta

UltraBrain propose un **canal bêta** avec des fonctionnalités expérimentales comme le **mode Endless** (architecture de mémoire biomimétique pour les sessions étendues). Basculez entre les versions stables et bêta depuis l'interface web de visualisation à http://localhost:37777 → Paramètres.

Voir la **[Documentation des fonctionnalités bêta](https://docs.ultrabrain.ai/beta-features)** pour plus de détails sur le mode Endless et comment l'essayer.
...
Les paramètres sont gérés dans `~/.ultrabrain/settings.json` (créé automatiquement avec les valeurs par défaut au premier lancement). Configurez le modèle IA, le port du worker, le répertoire de données, le niveau de journalisation et les paramètres d'injection de contexte.

Voir le **[Guide de configuration](https://docs.ultrabrain.ai/configuration)** pour tous les paramètres disponibles et des exemples.

---

## Développement

Voir le **[Guide de développement](https://docs.ultrabrain.ai/development)** pour les instructions de compilation, les tests et le flux de contribution.
...
Voir le **[Guide de dépannage](https://docs.ultrabrain.ai/troubleshooting)** pour les problèmes courants et les solutions.
...
Voir le [Guide de développement](https://docs.ultrabrain.ai/development) pour le flux de contribution.
...
Copyright (c) 2026 Giuliano Falco (@giulianofalco). Tous droits réservés.
...
- Les œuvres dérivées doivent également être sous licence MIT
...
- **Dépôt** : [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Auteur** : Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
