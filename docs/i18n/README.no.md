...
<p align="center">
  UltraBrain bevarer sømløst kontekst på tvers av økter ved automatisk å fange opp observasjoner av verktøybruk, generere semantiske sammendrag, og gjøre dem tilgjengelige for fremtidige økter. Dette gjør det mulig for Claude å opprettholde kunnskapskontinuitet om prosjekter selv etter at økter avsluttes eller gjenopprettes.
</p>
...
📚 **[Se Full Dokumentasjon](https://docs.ultrabrain.ai/)** - Bla gjennom på det offisielle nettstedet

### Komme I Gang

- **[Installasjonsveiledning](https://docs.ultrabrain.ai/installation)** - Hurtigstart og avansert installasjon
- **[Brukerveiledning](https://docs.ultrabrain.ai/usage/getting-started)** - Hvordan UltraBrain fungerer automatisk
- **[Søkeverktøy](https://docs.ultrabrain.ai/usage/search-tools)** - Spør om prosjekthistorikken din med naturlig språk
- **[Beta-funksjoner](https://docs.ultrabrain.ai/beta-features)** - Prøv eksperimentelle funksjoner som Endless Mode

### Beste Praksis

- **[Kontekst Engineering](https://docs.ultrabrain.ai/context-engineering)** - Optimaliseringsprinsipper for AI-agentkontekst
- **[Progressiv Avsløring](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofien bak UltraBrains strategi for kontekstpriming

### Arkitektur

- **[Oversikt](https://docs.ultrabrain.ai/architecture/overview)** - Systemkomponenter og dataflyt
- **[Arkitekturutvikling](https://docs.ultrabrain.ai/architecture-evolution)** - Reisen fra v3 til v5
- **[Hooks-arkitektur](https://docs.ultrabrain.ai/hooks-architecture)** - Hvordan UltraBrain bruker livssyklus-hooks
- **[Hooks-referanse](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook-skript forklart
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API og Bun-administrasjon
- **[Database](https://docs.ultrabrain.ai/architecture/database)** - SQLite-skjema og FTS5-søk
- **[Søkearkitektur](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybridsøk med Lance vektordatabase

### Konfigurasjon og Utvikling

- **[Konfigurasjon](https://docs.ultrabrain.ai/configuration)** - Miljøvariabler og innstillinger
- **[Utvikling](https://docs.ultrabrain.ai/development)** - Bygging, testing, bidragsflyt
- **[Feilsøking](https://docs.ultrabrain.ai/troubleshooting)** - Vanlige problemer og løsninger
...
6. **Lance Vektordatabase** - Hybrid semantisk + nøkkelordsøk for intelligent konteksthenting

Se [Arkitekturoversikt](https://docs.ultrabrain.ai/architecture/overview) for detaljer.

---

## mem-search-ferdighet

UltraBrain tilbyr intelligent søk gjennom mem-search-ferdigheten som automatisk aktiveres når du spør om tidligere arbeid:
...
Se [Søkeverktøy-veiledning](https://docs.ultrabrain.ai/usage/search-tools) for detaljerte eksempler.

---

## Beta-funksjoner

UltraBrain tilbyr en **beta-kanal** med eksperimentelle funksjoner som **Endless Mode** (biomimetisk minnearkitektur for utvidede økter). Bytt mellom stabile og beta-versjoner fra nettleser-UI på http://localhost:37777 → Settings.

Se **[Beta-funksjoner Dokumentasjon](https://docs.ultrabrain.ai/beta-features)** for detaljer om Endless Mode og hvordan du prøver det.
...
Innstillinger administreres i `~/.ultrabrain/settings.json` (opprettes automatisk med standardverdier ved første kjøring). Konfigurer AI-modell, worker-port, datakatalog, loggnivå og innstillinger for kontekstinjeksjon.

Se **[Konfigurasjonsveiledning](https://docs.ultrabrain.ai/configuration)** for alle tilgjengelige innstillinger og eksempler.

---

## Utvikling

Se **[Utviklingsveiledning](https://docs.ultrabrain.ai/development)** for byggeinstruksjoner, testing og bidragsflyt.
...
Se **[Feilsøkingsveiledning](https://docs.ultrabrain.ai/troubleshooting)** for vanlige problemer og løsninger.
...
Se [Utviklingsveiledning](https://docs.ultrabrain.ai/development) for bidragsflyt.

---

## Lisens

Dette prosjektet er lisensiert under **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Alle rettigheter reservert.
...
- Avledede verk må også være lisensiert under MIT
...
- **Problemer**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Forfatter**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
