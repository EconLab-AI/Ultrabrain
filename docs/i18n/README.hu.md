...
📚 **[Teljes dokumentáció megtekintése](https://docs.ultrabrain.ai/)** - Böngészés a hivatalos weboldalon

### Első lépések

- **[Telepítési útmutató](https://docs.ultrabrain.ai/installation)** - Gyors indítás és haladó telepítés
- **[Használati útmutató](https://docs.ultrabrain.ai/usage/getting-started)** - Hogyan működik automatikusan a UltraBrain
- **[Keresési eszközök](https://docs.ultrabrain.ai/usage/search-tools)** - Projekt előzmények lekérdezése természetes nyelvvel
- **[Béta funkciók](https://docs.ultrabrain.ai/beta-features)** - Kísérleti funkciók, mint az Endless Mode kipróbálása

### Bevált gyakorlatok

- **[Kontextus tervezés](https://docs.ultrabrain.ai/context-engineering)** - AI ügynök kontextus optimalizálási elvek
- **[Progresszív felfedés](https://docs.ultrabrain.ai/progressive-disclosure)** - A UltraBrain kontextus előkészítési stratégiájának filozófiája

### Architektúra

- **[Áttekintés](https://docs.ultrabrain.ai/architecture/overview)** - Rendszerkomponensek és adatfolyam
- **[Architektúra fejlődés](https://docs.ultrabrain.ai/architecture-evolution)** - Az út a v3-tól a v5-ig
- **[Hooks architektúra](https://docs.ultrabrain.ai/hooks-architecture)** - Hogyan használja a UltraBrain az életciklus hookokat
- **[Hooks referencia](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook szkript magyarázata
- **[Worker szolgáltatás](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API és Bun kezelés
- **[Adatbázis](https://docs.ultrabrain.ai/architecture/database)** - SQLite séma és FTS5 keresés
- **[Keresési architektúra](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hibrid keresés Lance vektor adatbázissal

### Konfiguráció és fejlesztés

- **[Konfiguráció](https://docs.ultrabrain.ai/configuration)** - Környezeti változók és beállítások
- **[Fejlesztés](https://docs.ultrabrain.ai/development)** - Építés, tesztelés, hozzájárulás
- **[Hibaelhárítás](https://docs.ultrabrain.ai/troubleshooting)** - Gyakori problémák és megoldások
...
6. **Lance vektor adatbázis** - Hibrid szemantikus + kulcsszó keresés intelligens kontextus visszakereséshez

További részletekért lásd az [Architektúra áttekintést](https://docs.ultrabrain.ai/architecture/overview).

---

## mem-search Skill

A UltraBrain intelligens keresést biztosít a mem-search skillen keresztül, amely automatikusan aktiválódik, amikor múltbeli munkáról kérdez:
...
Részletes példákért lásd a [Keresési eszközök útmutatót](https://docs.ultrabrain.ai/usage/search-tools).

---

## Béta funkciók

A UltraBrain **béta csatornát** kínál kísérleti funkciókkal, mint az **Endless Mode** (biomimetikus memória architektúra hosszabb munkamenetekhez). Váltson a stabil és béta verziók között a webes megjelenítő felületről a http://localhost:37777 → Settings címen.

További részletekért az Endless Mode-ról és annak kipróbálásáról lásd a **[Béta funkciók dokumentációt](https://docs.ultrabrain.ai/beta-features)**.
...
A beállítások a `~/.ultrabrain/settings.json` fájlban kezelhetők (automatikusan létrejön alapértelmezett értékekkel az első futtatáskor). Konfigurálható az AI modell, worker port, adatkönyvtár, naplózási szint és kontextus beillesztési beállítások.

Az összes elérhető beállításért és példákért lásd a **[Konfigurációs útmutatót](https://docs.ultrabrain.ai/configuration)**.

---

## Fejlesztés

Az építési utasításokért, tesztelésért és hozzájárulási munkafolyamatért lásd a **[Fejlesztési útmutatót](https://docs.ultrabrain.ai/development)**.
...
Gyakori problémákért és megoldásokért lásd a **[Hibaelhárítási útmutatót](https://docs.ultrabrain.ai/troubleshooting)**.
...
A hozzájárulási munkafolyamatért lásd a [Fejlesztési útmutatót](https://docs.ultrabrain.ai/development).
...
- **Hibák**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Tároló**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Szerző**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
