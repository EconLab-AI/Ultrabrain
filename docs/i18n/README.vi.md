...
📚 **[Xem Tài Liệu Đầy Đủ](https://docs.ultrabrain.ai/)** - Duyệt trên trang web chính thức

### Bắt Đầu

- **[Hướng Dẫn Cài Đặt](https://docs.ultrabrain.ai/installation)** - Bắt đầu nhanh & cài đặt nâng cao
- **[Hướng Dẫn Sử Dụng](https://docs.ultrabrain.ai/usage/getting-started)** - Cách UltraBrain hoạt động tự động
- **[Công Cụ Tìm Kiếm](https://docs.ultrabrain.ai/usage/search-tools)** - Truy vấn lịch sử dự án bằng ngôn ngữ tự nhiên
- **[Tính Năng Beta](https://docs.ultrabrain.ai/beta-features)** - Dùng thử các tính năng thử nghiệm như Endless Mode

### Thực Hành Tốt Nhất

- **[Kỹ Thuật Ngữ Cảnh](https://docs.ultrabrain.ai/context-engineering)** - Các nguyên tắc tối ưu hóa ngữ cảnh cho AI agent
- **[Tiết Lộ Tuần Tự](https://docs.ultrabrain.ai/progressive-disclosure)** - Triết lý đằng sau chiến lược chuẩn bị ngữ cảnh của UltraBrain

### Kiến Trúc

- **[Tổng Quan](https://docs.ultrabrain.ai/architecture/overview)** - Các thành phần hệ thống & luồng dữ liệu
- **[Phát Triển Kiến Trúc](https://docs.ultrabrain.ai/architecture-evolution)** - Hành trình từ v3 đến v5
- **[Kiến Trúc Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Cách UltraBrain sử dụng lifecycle hooks
- **[Tham Chiếu Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - Giải thích 7 hook scripts
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API & quản lý Bun
- **[Cơ Sở Dữ Liệu](https://docs.ultrabrain.ai/architecture/database)** - Schema SQLite & tìm kiếm FTS5
- **[Kiến Trúc Tìm Kiếm](https://docs.ultrabrain.ai/architecture/search-architecture)** - Tìm kiếm kết hợp với cơ sở dữ liệu vector Chroma

### Cấu Hình & Phát Triển

- **[Cấu Hình](https://docs.ultrabrain.ai/configuration)** - Biến môi trường & cài đặt
- **[Phát Triển](https://docs.ultrabrain.ai/development)** - Xây dựng, kiểm thử, đóng góp
- **[Khắc Phục Sự Cố](https://docs.ultrabrain.ai/troubleshooting)** - Các vấn đề thường gặp & giải pháp
...
6. **Lance Vector Database** - Tìm kiếm kết hợp ngữ nghĩa + từ khóa để truy xuất ngữ cảnh thông minh

Xem [Tổng Quan Kiến Trúc](https://docs.ultrabrain.ai/architecture/overview) để biết chi tiết.

---

## mem-search Skill

UltraBrain cung cấp tìm kiếm thông minh thông qua kỹ năng mem-search tự động kích hoạt khi bạn hỏi về công việc trước đây:
...
Xem [Hướng Dẫn Công Cụ Tìm Kiếm](https://docs.ultrabrain.ai/usage/search-tools) để biết các ví dụ chi tiết.

---

## Tính Năng Beta

UltraBrain cung cấp **kênh beta** với các tính năng thử nghiệm như **Endless Mode** (kiến trúc bộ nhớ sinh học mô phỏng cho các phiên mở rộng). Chuyển đổi giữa các phiên bản ổn định và beta từ giao diện web viewer tại http://localhost:37777 → Settings.

Xem **[Tài Liệu Tính Năng Beta](https://docs.ultrabrain.ai/beta-features)** để biết chi tiết về Endless Mode và cách dùng thử.
...
Cài đặt được quản lý trong `~/.ultrabrain/settings.json` (tự động tạo với giá trị mặc định khi chạy lần đầu). Cấu hình mô hình AI, cổng worker, thư mục dữ liệu, mức độ log và cài đặt chèn ngữ cảnh.

Xem **[Hướng Dẫn Cấu Hình](https://docs.ultrabrain.ai/configuration)** để biết tất cả các cài đặt và ví dụ có sẵn.

---

## Phát Triển

Xem **[Hướng Dẫn Phát Triển](https://docs.ultrabrain.ai/development)** để biết hướng dẫn xây dựng, kiểm thử và quy trình đóng góp.
...
Xem **[Hướng Dẫn Khắc Phục Sự Cố](https://docs.ultrabrain.ai/troubleshooting)** để biết các vấn đề thường gặp và giải pháp.
...
Xem [Hướng Dẫn Phát Triển](https://docs.ultrabrain.ai/development) để biết quy trình đóng góp.
...
- **Tài Liệu**: [docs/](docs/)
- **Vấn Đề**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Tác Giả**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
