...
📚 **[Προβολή Πλήρους Τεκμηρίωσης](https://docs.ultrabrain.ai/)** - Περιήγηση στον επίσημο ιστότοπο

### Ξεκινώντας

- **[Οδηγός Εγκατάστασης](https://docs.ultrabrain.ai/installation)** - Γρήγορη εκκίνηση & προηγμένη εγκατάσταση
- **[Οδηγός Χρήσης](https://docs.ultrabrain.ai/usage/getting-started)** - Πώς λειτουργεί αυτόματα το UltraBrain
- **[Εργαλεία Αναζήτησης](https://docs.ultrabrain.ai/usage/search-tools)** - Ερωτήματα στο ιστορικό του έργου σας με φυσική γλώσσα
- **[Χαρακτηριστικά Beta](https://docs.ultrabrain.ai/beta-features)** - Δοκιμάστε πειραματικά χαρακτηριστικά όπως το Endless Mode

### Βέλτιστες Πρακτικές

- **[Μηχανική Πλαισίου](https://docs.ultrabrain.ai/context-engineering)** - Αρχές βελτιστοποίησης πλαισίου για AI agents
- **[Προοδευτική Αποκάλυψη](https://docs.ultrabrain.ai/progressive-disclosure)** - Φιλοσοφία πίσω από τη στρατηγική προετοιμασίας πλαισίου του UltraBrain

### Αρχιτεκτονική

- **[Επισκόπηση](https://docs.ultrabrain.ai/architecture/overview)** - Συστατικά στοιχεία συστήματος & ροή δεδομένων
- **[Εξέλιξη Αρχιτεκτονικής](https://docs.ultrabrain.ai/architecture-evolution)** - Το ταξίδι από το v3 στο v5
- **[Αρχιτεκτονική Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Πώς το UltraBrain χρησιμοποιεί lifecycle hooks
- **[Αναφορά Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - Επεξήγηση 7 hook scripts
- **[Υπηρεσία Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API & διαχείριση Bun
- **[Βάση Δεδομένων](https://docs.ultrabrain.ai/architecture/database)** - Σχήμα SQLite & αναζήτηση FTS5
- **[Αρχιτεκτονική Αναζήτησης](https://docs.ultrabrain.ai/architecture/search-architecture)** - Υβριδική αναζήτηση με βάση δεδομένων διανυσμάτων Chroma

### Διαμόρφωση & Ανάπτυξη

- **[Διαμόρφωση](https://docs.ultrabrain.ai/configuration)** - Μεταβλητές περιβάλλοντος & ρυθμίσεις
- **[Ανάπτυξη](https://docs.ultrabrain.ai/development)** - Κατασκευή, δοκιμή, συνεισφορά
- **[Αντιμετώπιση Προβλημάτων](https://docs.ultrabrain.ai/troubleshooting)** - Συνήθη προβλήματα & λύσεις
...
Δείτε [Επισκόπηση Αρχιτεκτονικής](https://docs.ultrabrain.ai/architecture/overview) για λεπτομέρειες.

---

## Δεξιότητα mem-search

Το UltraBrain παρέχει έξυπνη αναζήτηση μέσω της δεξιότητας mem-search που ενεργοποιείται αυτόματα όταν ρωτάτε για παλαιότερη εργασία:
...
Δείτε [Οδηγό Εργαλείων Αναζήτησης](https://docs.ultrabrain.ai/usage/search-tools) για λεπτομερή παραδείγματα.

---

## Χαρακτηριστικά Beta

Το UltraBrain προσφέρει ένα **κανάλι beta** με πειραματικά χαρακτηριστικά όπως το **Endless Mode** (βιομιμητική αρχιτεκτονική μνήμης για εκτεταμένες συνεδρίες). Εναλλαγή μεταξύ σταθερών και beta εκδόσεων από τη διεπαφή web viewer στο http://localhost:37777 → Settings.

Δείτε **[Τεκμηρίωση Χαρακτηριστικών Beta](https://docs.ultrabrain.ai/beta-features)** για λεπτομέρειες σχετικά με το Endless Mode και πώς να το δοκιμάσετε.
...
Οι ρυθμίσεις διαχειρίζονται στο `~/.ultrabrain/settings.json` (δημιουργείται αυτόματα με προεπιλογές κατά την πρώτη εκτέλεση). Διαμορφώστε το μοντέλο AI, τη θύρα worker, τον κατάλογο δεδομένων, το επίπεδο καταγραφής και τις ρυθμίσεις εισαγωγής πλαισίου.

Δείτε τον **[Οδηγό Διαμόρφωσης](https://docs.ultrabrain.ai/configuration)** για όλες τις διαθέσιμες ρυθμίσεις και παραδείγματα.

---

## Ανάπτυξη

Δείτε τον **[Οδηγό Ανάπτυξης](https://docs.ultrabrain.ai/development)** για οδηγίες κατασκευής, δοκιμών και ροής εργασίας συνεισφοράς.
...
Δείτε τον **[Οδηγό Αντιμετώπισης Προβλημάτων](https://docs.ultrabrain.ai/troubleshooting)** για συνήθη προβλήματα και λύσεις.
...
Δείτε τον [Οδηγό Ανάπτυξης](https://docs.ultrabrain.ai/development) για τη ροή εργασίας συνεισφοράς.

---

## Άδεια Χρήσης

Αυτό το έργο διατίθεται με άδεια **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Με επιφύλαξη παντός δικαιώματος.
...
- Τα παράγωγα έργα πρέπει επίσης να διατίθενται με άδεια MIT
...
- **Ζητήματα**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Συγγραφέας**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
