...
📚 **[Tam Dokümantasyonu Görüntüle](https://docs.ultrabrain.ai/)** - Resmi web sitesinde göz atın

### Başlarken

- **[Kurulum Kılavuzu](https://docs.ultrabrain.ai/installation)** - Hızlı başlangıç ve gelişmiş kurulum
- **[Kullanım Kılavuzu](https://docs.ultrabrain.ai/usage/getting-started)** - UltraBrain otomatik olarak nasıl çalışır
- **[Arama Araçları](https://docs.ultrabrain.ai/usage/search-tools)** - Doğal dil ile proje geçmişinizi sorgulayın
- **[Beta Özellikleri](https://docs.ultrabrain.ai/beta-features)** - Endless Mode gibi deneysel özellikleri deneyin

### En İyi Uygulamalar

- **[Bağlam Mühendisliği](https://docs.ultrabrain.ai/context-engineering)** - AI ajan bağlam optimizasyon ilkeleri
- **[Aşamalı Açıklama](https://docs.ultrabrain.ai/progressive-disclosure)** - UltraBrain'in bağlam hazırlama stratejisinin ardındaki felsefe

### Mimari

- **[Genel Bakış](https://docs.ultrabrain.ai/architecture/overview)** - Sistem bileşenleri ve veri akışı
- **[Mimari Evrimi](https://docs.ultrabrain.ai/architecture-evolution)** - v3'ten v5'e yolculuk
- **[Hooks Mimarisi](https://docs.ultrabrain.ai/hooks-architecture)** - UltraBrain yaşam döngüsü hook'larını nasıl kullanır
- **[Hooks Referansı](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook betiği açıklandı
- **[Worker Servisi](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API ve Bun yönetimi
- **[Veritabanı](https://docs.ultrabrain.ai/architecture/database)** - SQLite şeması ve FTS5 arama
- **[Arama Mimarisi](https://docs.ultrabrain.ai/architecture/search-architecture)** - Lance vektör veritabanı ile hibrit arama

### Yapılandırma ve Geliştirme

- **[Yapılandırma](https://docs.ultrabrain.ai/configuration)** - Ortam değişkenleri ve ayarlar
- **[Geliştirme](https://docs.ultrabrain.ai/development)** - Derleme, test etme, katkıda bulunma
- **[Sorun Giderme](https://docs.ultrabrain.ai/troubleshooting)** - Yaygın sorunlar ve çözümler
...
6. **Lance Vektör Veritabanı** - Akıllı bağlam erişimi için hibrit anlamsal + anahtar kelime arama

Detaylar için [Mimari Genel Bakış](https://docs.ultrabrain.ai/architecture/overview) bölümüne bakın.

---

## mem-search Becerisi

UltraBrain, geçmiş çalışmalarınız hakkında sorduğunuzda otomatik olarak devreye giren mem-search becerisi aracılığıyla akıllı arama sağlar:
...
Detaylı örnekler için [Arama Araçları Kılavuzu](https://docs.ultrabrain.ai/usage/search-tools) bölümüne bakın.

---

## Beta Özellikleri

UltraBrain, **Endless Mode** (genişletilmiş oturumlar için biyomimetik bellek mimarisi) gibi deneysel özellikler içeren bir **beta kanalı** sunar. http://localhost:37777 → Settings adresindeki web görüntüleyici arayüzünden kararlı ve beta sürümleri arasında geçiş yapın.

Endless Mode hakkında detaylar ve nasıl deneyeceğiniz için **[Beta Özellikleri Dokümantasyonu](https://docs.ultrabrain.ai/beta-features)** bölümüne bakın.
...
Ayarlar `~/.ultrabrain/settings.json` dosyasında yönetilir (ilk çalıştırmada varsayılanlarla otomatik oluşturulur). AI modelini, worker portunu, veri dizinini, log seviyesini ve bağlam enjeksiyon ayarlarını yapılandırın.

Tüm mevcut ayarlar ve örnekler için **[Yapılandırma Kılavuzu](https://docs.ultrabrain.ai/configuration)** bölümüne bakın.

---

## Geliştirme

Derleme talimatları, test etme ve katkı iş akışı için **[Geliştirme Kılavuzu](https://docs.ultrabrain.ai/development)** bölümüne bakın.
...
Yaygın sorunlar ve çözümler için **[Sorun Giderme Kılavuzu](https://docs.ultrabrain.ai/troubleshooting)** bölümüne bakın.
...
Katkı iş akışı için [Geliştirme Kılavuzu](https://docs.ultrabrain.ai/development) bölümüne bakın.
...
- **Sorunlar**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Depo**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Yazar**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
