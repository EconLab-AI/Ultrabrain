...
📚 **[Vizualizați Documentația Completă](https://docs.ultrabrain.ai/)** - Răsfoiți pe site-ul oficial

### Introducere

- **[Ghid de Instalare](https://docs.ultrabrain.ai/installation)** - Start rapid și instalare avansată
- **[Ghid de Utilizare](https://docs.ultrabrain.ai/usage/getting-started)** - Cum funcționează UltraBrain automat
- **[Instrumente de Căutare](https://docs.ultrabrain.ai/usage/search-tools)** - Interogați istoricul proiectului cu limbaj natural
- **[Funcții Beta](https://docs.ultrabrain.ai/beta-features)** - Încercați funcții experimentale precum Endless Mode

### Practici Recomandate

- **[Inginerie Context](https://docs.ultrabrain.ai/context-engineering)** - Principii de optimizare a contextului pentru agenți AI
- **[Dezvăluire Progresivă](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofia din spatele strategiei de pregătire a contextului UltraBrain

### Arhitectură

- **[Prezentare Generală](https://docs.ultrabrain.ai/architecture/overview)** - Componente de sistem și flux de date
- **[Evoluția Arhitecturii](https://docs.ultrabrain.ai/architecture-evolution)** - Parcursul de la v3 la v5
- **[Arhitectura Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Cum folosește UltraBrain hook-urile de ciclu de viață
- **[Referință Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - 7 scripturi de hook explicate
- **[Serviciu Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API și gestionare Bun
- **[Baza de Date](https://docs.ultrabrain.ai/architecture/database)** - Schemă SQLite și căutare FTS5
- **[Arhitectura Căutării](https://docs.ultrabrain.ai/architecture/search-architecture)** - Căutare hibridă cu baza de date vectorială Chroma

### Configurare și Dezvoltare

- **[Configurare](https://docs.ultrabrain.ai/configuration)** - Variabile de mediu și setări
- **[Dezvoltare](https://docs.ultrabrain.ai/development)** - Construire, testare, contribuție
- **[Depanare](https://docs.ultrabrain.ai/troubleshooting)** - Probleme comune și soluții
...
Consultați [Prezentarea Generală a Arhitecturii](https://docs.ultrabrain.ai/architecture/overview) pentru detalii.

---

## Abilitatea mem-search

UltraBrain oferă căutare inteligentă prin abilitatea mem-search care se invocă automat când întrebați despre lucrul trecut:
...
Consultați [Ghidul Instrumentelor de Căutare](https://docs.ultrabrain.ai/usage/search-tools) pentru exemple detaliate.

---

## Funcții Beta

UltraBrain oferă un **canal beta** cu funcții experimentale precum **Endless Mode** (arhitectură de memorie biomimetică pentru sesiuni extinse). Comutați între versiunile stabile și beta din interfața web viewer la http://localhost:37777 → Settings.

Consultați **[Documentația Funcțiilor Beta](https://docs.ultrabrain.ai/beta-features)** pentru detalii despre Endless Mode și cum să îl încercați.
...
Setările sunt gestionate în `~/.ultrabrain/settings.json` (creat automat cu valori implicite la prima rulare). Configurați modelul AI, portul worker, directorul de date, nivelul de log și setările de injectare a contextului.

Consultați **[Ghidul de Configurare](https://docs.ultrabrain.ai/configuration)** pentru toate setările disponibile și exemple.

---

## Dezvoltare

Consultați **[Ghidul de Dezvoltare](https://docs.ultrabrain.ai/development)** pentru instrucțiuni de construire, testare și flux de contribuție.
...
Consultați **[Ghidul de Depanare](https://docs.ultrabrain.ai/troubleshooting)** pentru probleme comune și soluții.
...
Consultați [Ghidul de Dezvoltare](https://docs.ultrabrain.ai/development) pentru fluxul de contribuție.
...
- **Probleme**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
