...
<p align="center">
  UltraBrain preserva el contexto sin interrupciones entre sesiones al capturar automáticamente observaciones de uso de herramientas, generar resúmenes semánticos y ponerlos a disposición de sesiones futuras. Esto permite a Claude mantener la continuidad del conocimiento sobre proyectos incluso después de que las sesiones terminen o se reconecten.
</p>
...
📚 **[Ver Documentación Completa](https://docs.ultrabrain.ai/)** - Navegar en el sitio web oficial

### Primeros Pasos

- **[Guía de Instalación](https://docs.ultrabrain.ai/installation)** - Inicio rápido e instalación avanzada
- **[Guía de Uso](https://docs.ultrabrain.ai/usage/getting-started)** - Cómo funciona UltraBrain automáticamente
- **[Herramientas de Búsqueda](https://docs.ultrabrain.ai/usage/search-tools)** - Consulta el historial de tu proyecto con lenguaje natural
- **[Características Beta](https://docs.ultrabrain.ai/beta-features)** - Prueba características experimentales como Endless Mode

### Mejores Prácticas

- **[Ingeniería de Contexto](https://docs.ultrabrain.ai/context-engineering)** - Principios de optimización de contexto para agentes de IA
- **[Divulgación Progresiva](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofía detrás de la estrategia de preparación de contexto de UltraBrain

### Arquitectura

- **[Descripción General](https://docs.ultrabrain.ai/architecture/overview)** - Componentes del sistema y flujo de datos
- **[Evolución de la Arquitectura](https://docs.ultrabrain.ai/architecture-evolution)** - El viaje de v3 a v5
- **[Arquitectura de Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Cómo UltraBrain usa hooks de ciclo de vida
- **[Referencia de Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - 7 scripts de hooks explicados
- **[Servicio Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - API HTTP y gestión de Bun
- **[Base de Datos](https://docs.ultrabrain.ai/architecture/database)** - Esquema SQLite y búsqueda FTS5
- **[Arquitectura de Búsqueda](https://docs.ultrabrain.ai/architecture/search-architecture)** - Búsqueda híbrida con base de datos vectorial Chroma

### Configuración y Desarrollo

- **[Configuración](https://docs.ultrabrain.ai/configuration)** - Variables de entorno y ajustes
- **[Desarrollo](https://docs.ultrabrain.ai/development)** - Compilación, pruebas y contribución
- **[Solución de Problemas](https://docs.ultrabrain.ai/troubleshooting)** - Problemas comunes y soluciones
...
Ver [Descripción General de la Arquitectura](https://docs.ultrabrain.ai/architecture/overview) para más detalles.

---

## Habilidad mem-search

UltraBrain proporciona búsqueda inteligente a través de la habilidad mem-search que se invoca automáticamente cuando preguntas sobre trabajo previo:
...
Ver [Guía de Herramientas de Búsqueda](https://docs.ultrabrain.ai/usage/search-tools) para ejemplos detallados.

---

## Características Beta

UltraBrain ofrece un **canal beta** con características experimentales como **Endless Mode** (arquitectura de memoria biomimética para sesiones extendidas). Cambia entre versiones estables y beta desde la interfaz del visor web en http://localhost:37777 → Settings.

Ver **[Documentación de Características Beta](https://docs.ultrabrain.ai/beta-features)** para detalles sobre Endless Mode y cómo probarlo.
...
Los ajustes se gestionan en `~/.ultrabrain/settings.json` (se crea automáticamente con valores predeterminados en la primera ejecución). Configura el modelo de IA, puerto del worker, directorio de datos, nivel de registro y ajustes de inyección de contexto.

Ver la **[Guía de Configuración](https://docs.ultrabrain.ai/configuration)** para todos los ajustes disponibles y ejemplos.

---

## Desarrollo

Ver la **[Guía de Desarrollo](https://docs.ultrabrain.ai/development)** para instrucciones de compilación, pruebas y flujo de contribución.
...
Ver la **[Guía de Solución de Problemas](https://docs.ultrabrain.ai/troubleshooting)** para problemas comunes y soluciones.
...
Ver [Guía de Desarrollo](https://docs.ultrabrain.ai/development) para el flujo de contribución.

---

## Licencia

Este proyecto está licenciado bajo la **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Todos los derechos reservados.
...
- Los trabajos derivados también deben estar licenciados bajo MIT
...
- **Problemas**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repositorio**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
