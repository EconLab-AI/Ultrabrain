...
📚 **[Se Fuld Dokumentation](https://docs.ultrabrain.ai/)** - Gennemse på den officielle hjemmeside

### Kom Godt I Gang

- **[Installationsguide](https://docs.ultrabrain.ai/installation)** - Hurtig start & avanceret installation
- **[Brugervejledning](https://docs.ultrabrain.ai/usage/getting-started)** - Sådan fungerer UltraBrain automatisk
- **[Søgeværktøjer](https://docs.ultrabrain.ai/usage/search-tools)** - Forespørg din projekthistorik med naturligt sprog
- **[Beta-funktioner](https://docs.ultrabrain.ai/beta-features)** - Prøv eksperimentelle funktioner som Endless Mode

### Bedste Praksis

- **[Kontekst-engineering](https://docs.ultrabrain.ai/context-engineering)** - AI-agent kontekstoptimeringsprincipper
- **[Progressiv Afsløring](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofien bag UltraBrains kontekst-priming-strategi

### Arkitektur

- **[Oversigt](https://docs.ultrabrain.ai/architecture/overview)** - Systemkomponenter & dataflow
- **[Arkitekturudvikling](https://docs.ultrabrain.ai/architecture-evolution)** - Rejsen fra v3 til v5
- **[Hooks-arkitektur](https://docs.ultrabrain.ai/hooks-architecture)** - Hvordan UltraBrain bruger livscyklus-hooks
- **[Hooks-reference](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook-scripts forklaret
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API & Bun-administration
- **[Database](https://docs.ultrabrain.ai/architecture/database)** - SQLite-skema & FTS5-søgning
- **[Søgearkitektur](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybrid søgning med Lance vektordatabase

### Konfiguration & Udvikling

- **[Konfiguration](https://docs.ultrabrain.ai/configuration)** - Miljøvariabler & indstillinger
- **[Udvikling](https://docs.ultrabrain.ai/development)** - Bygning, testning, bidrag
- **[Fejlfinding](https://docs.ultrabrain.ai/troubleshooting)** - Almindelige problemer & løsninger
...
6. **Lance Vector Database** - Hybrid semantisk + søgeordssøgning for intelligent konteksthentning

Se [Arkitekturoversigt](https://docs.ultrabrain.ai/architecture/overview) for detaljer.

---

## mem-search-færdighed

UltraBrain leverer intelligent søgning gennem mem-search-færdigheden, der automatisk aktiveres, når du spørger om tidligere arbejde:
...
Se [Søgeværktøjsguide](https://docs.ultrabrain.ai/usage/search-tools) for detaljerede eksempler.

---

## Beta-funktioner

UltraBrain tilbyder en **beta-kanal** med eksperimentelle funktioner som **Endless Mode** (biomimetisk hukommelsesarkitektur til udvidede sessioner). Skift mellem stabile og beta-versioner fra web viewer UI på http://localhost:37777 → Settings.

Se **[Beta-funktionsdokumentation](https://docs.ultrabrain.ai/beta-features)** for detaljer om Endless Mode og hvordan du prøver det.
...
Indstillinger administreres i `~/.ultrabrain/settings.json` (auto-oprettet med standardindstillinger ved første kørsel). Konfigurer AI-model, worker-port, datakatalog, log-niveau og indstillinger for kontekstindsprøjtning.

Se **[Konfigurationsguide](https://docs.ultrabrain.ai/configuration)** for alle tilgængelige indstillinger og eksempler.

---

## Udvikling

Se **[Udviklingsguide](https://docs.ultrabrain.ai/development)** for bygningsinstruktioner, testning og bidragsworkflow.
...
Se **[Fejlfindingsguide](https://docs.ultrabrain.ai/troubleshooting)** for almindelige problemer og løsninger.
...
Se [Udviklingsguide](https://docs.ultrabrain.ai/development) for bidragsworkflow.

---

## Licens

Dette projekt er licenseret under **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Alle rettigheder forbeholdes.
...
- Afledte værker skal også licenseres under MIT
