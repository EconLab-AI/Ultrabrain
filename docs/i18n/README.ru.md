...
<p align="center">
  UltraBrain бесшовно сохраняет контекст между сеансами, автоматически фиксируя наблюдения за использованием инструментов, генерируя семантические сводки и делая их доступными для будущих сеансов. Это позволяет Claude поддерживать непрерывность знаний о проектах даже после завершения или переподключения сеансов.
</p>
...
📚 **[Просмотреть полную документацию](https://docs.ultrabrain.ai/)** - Просмотр на официальном сайте

### Начало работы

- **[Руководство по установке](https://docs.ultrabrain.ai/installation)** - Быстрый старт и продвинутая установка
- **[Руководство по использованию](https://docs.ultrabrain.ai/usage/getting-started)** - Как UltraBrain работает автоматически
- **[Инструменты поиска](https://docs.ultrabrain.ai/usage/search-tools)** - Запросы к истории проекта на естественном языке
- **[Бета-функции](https://docs.ultrabrain.ai/beta-features)** - Попробуйте экспериментальные функции, такие как режим Endless

### Лучшие практики

- **[Инженерия контекста](https://docs.ultrabrain.ai/context-engineering)** - Принципы оптимизации контекста для AI-агентов
- **[Прогрессивное раскрытие](https://docs.ultrabrain.ai/progressive-disclosure)** - Философия стратегии подготовки контекста в UltraBrain

### Архитектура

- **[Обзор](https://docs.ultrabrain.ai/architecture/overview)** - Компоненты системы и поток данных
- **[Эволюция архитектуры](https://docs.ultrabrain.ai/architecture-evolution)** - Путь от v3 к v5
- **[Архитектура хуков](https://docs.ultrabrain.ai/hooks-architecture)** - Как UltraBrain использует хуки жизненного цикла
- **[Справочник по хукам](https://docs.ultrabrain.ai/architecture/hooks)** - Объяснение 7 скриптов хуков
- **[Сервис Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API и управление Bun
- **[База данных](https://docs.ultrabrain.ai/architecture/database)** - Схема SQLite и поиск FTS5
- **[Архитектура поиска](https://docs.ultrabrain.ai/architecture/search-architecture)** - Гибридный поиск с векторной базой данных Chroma

### Конфигурация и разработка

- **[Конфигурация](https://docs.ultrabrain.ai/configuration)** - Переменные окружения и настройки
- **[Разработка](https://docs.ultrabrain.ai/development)** - Сборка, тестирование, участие в разработке
- **[Устранение неполадок](https://docs.ultrabrain.ai/troubleshooting)** - Распространенные проблемы и решения
...
Подробности см. в [Обзоре архитектуры](https://docs.ultrabrain.ai/architecture/overview).

---

## Навык mem-search

UltraBrain предоставляет интеллектуальный поиск через навык mem-search, который автоматически вызывается, когда вы спрашиваете о прошлой работе:
...
Подробные примеры см. в [Руководстве по инструментам поиска](https://docs.ultrabrain.ai/usage/search-tools).

---

## Бета-функции

UltraBrain предлагает **бета-канал** с экспериментальными функциями, такими как **режим Endless** (биомиметическая архитектура памяти для расширенных сеансов). Переключайтесь между стабильной и бета-версиями из веб-интерфейса на http://localhost:37777 → Settings.

Подробности о режиме Endless и способах его опробовать см. в **[Документации по бета-функциям](https://docs.ultrabrain.ai/beta-features)**.
...
Настройки управляются в `~/.ultrabrain/settings.json` (автоматически создается с настройками по умолчанию при первом запуске). Настройте AI-модель, порт worker, директорию данных, уровень логирования и параметры внедрения контекста.

Все доступные настройки и примеры см. в **[Руководстве по конфигурации](https://docs.ultrabrain.ai/configuration)**.

---

## Разработка

Инструкции по сборке, тестированию и процессу участия в разработке см. в **[Руководстве по разработке](https://docs.ultrabrain.ai/development)**.
...
Распространенные проблемы и решения см. в **[Руководстве по устранению неполадок](https://docs.ultrabrain.ai/troubleshooting)**.
...
Процесс участия см. в [Руководстве по разработке](https://docs.ultrabrain.ai/development).

---

## Лицензия

Этот проект лицензирован под **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Все права защищены.
...
- Производные работы также должны быть лицензированы под MIT
...
- **Проблемы**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Репозиторий**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Автор**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
