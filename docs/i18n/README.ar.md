...
UltraBrain هو نظام متطور مصمم لضغط وحفظ الذاكرة لسياق عمل Claude Code. وظيفته الأساسية هي جعل "كلود" يتذكر ما فعله في جلسات العمل السابقة بسلاسة، عبر تسجيل تحركاته، وإنشاء ملخصات ذكية، واستدعائها في الجلسات المستقبلية. هذا يضمن عدم ضياع سياق المشروع حتى لو أغلقت البرنامج وفتحته لاحقاً.
</p>
...
📚 **[عرض التوثيق الكامل](https://docs.ultrabrain.ai/)** - تصفح على الموقع الرسمي

### البدء

- **[دليل التثبيت](https://docs.ultrabrain.ai/installation)** - البدء السريع والتثبيت المتقدم
- **[دليل الاستخدام](https://docs.ultrabrain.ai/usage/getting-started)** - كيف يعمل UltraBrain تلقائيًا
- **[أدوات البحث](https://docs.ultrabrain.ai/usage/search-tools)** - استعلم عن سجل مشروعك بلغتك
- **[الميزات التجريبية](https://docs.ultrabrain.ai/beta-features)** - جرّب الميزات التجريبية مثل Endless Mode

### أفضل الممارسات

- **[هندسة السياق](https://docs.ultrabrain.ai/context-engineering)** - مبادئ تحسين سياق وكيل الذكاء الاصطناعي
- **[الكشف التدريجي](https://docs.ultrabrain.ai/progressive-disclosure)** - الفلسفة وراء استراتيجية تهيئة السياق في UltraBrain

### البنية المعمارية

- **[نظرة عامة](https://docs.ultrabrain.ai/architecture/overview)** - مكونات النظام وتدفق البيانات
- **[تطور البنية المعمارية](https://docs.ultrabrain.ai/architecture-evolution)** - تطور المعمارية من v3 إلى v5
- **[بنية برامج الربط (Hooks)](https://docs.ultrabrain.ai/hooks-architecture)** - كيف يستخدم UltraBrain خطافات دورة الحياة
- **[مرجع برامج الربط (Hooks)](https://docs.ultrabrain.ai/architecture/hooks)** - شرح 7 سكريبتات خطافات
- **[خدمة العامل](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API وإدارة Bun
- **[قاعدة البيانات](https://docs.ultrabrain.ai/architecture/database)** - مخطط SQLite وبحث FTS5
- **[بنية البحث](https://docs.ultrabrain.ai/architecture/search-architecture)** - البحث المختلط مع قاعدة بيانات المتجهات Chroma

### الإعدادات والتطوير

- **[الإعدادات](https://docs.ultrabrain.ai/configuration)** - متغيرات البيئة والإعدادات
- **[التطوير](https://docs.ultrabrain.ai/development)** - البناء، الاختبار، سير العمل للمساهمة
- **[استكشاف الأخطاء وإصلاحها](https://docs.ultrabrain.ai/troubleshooting)** - المشكلات الشائعة والحلول
...
انظر [نظرة عامة على البنية المعمارية](https://docs.ultrabrain.ai/architecture/overview) للتفاصيل.

---

## أدوات البحث (MCP Search Tools)
يوفر UltraBrain بحثًا ذكيًا من خلال مهارة mem-search التي تُستدعى تلقائيًا عندما تسأل عن العمل السابق:
...
انظر [دليل أدوات البحث](https://docs.ultrabrain.ai/usage/search-tools) لأمثلة مفصلة.

---

## الميزات التجريبية

يقدم UltraBrain **قناة تجريبية** بميزات تجريبية مثل **Endless Mode** (بنية ذاكرة بيوميمتية للجلسات الممتدة). بدّل بين الإصدارات المستقرة والتجريبية من واجهة مستخدم عارض الويب على http://localhost:37777 ← الإعدادات.

انظر **[توثيق الميزات التجريبية](https://docs.ultrabrain.ai/beta-features)** لتفاصيل حول Endless Mode وكيفية تجربته.
...
تتم إدارة الإعدادات في `~/.ultrabrain/settings.json` (يتم إنشاؤه تلقائيًا بالقيم الافتراضية عند التشغيل الأول). قم بتكوين نموذج الذكاء الاصطناعي، منفذ العامل، دليل البيانات، مستوى السجل، وإعدادات حقن السياق.

انظر **[دليل الإعدادات](https://docs.ultrabrain.ai/configuration)** لجميع الإعدادات المتاحة والأمثلة.

---

## التطوير

انظر **[دليل التطوير](https://docs.ultrabrain.ai/development)** لتعليمات البناء، الاختبار، وسير عمل المساهمة.
...
انظر **[دليل استكشاف الأخطاء وإصلاحها](https://docs.ultrabrain.ai/troubleshooting)** للمشكلات الشائعة والحلول.
...
انظر [دليل التطوير](https://docs.ultrabrain.ai/development) لسير عمل المساهمة.
...
- **التوثيق**: [docs/](docs/)
- **المشكلات**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **المستودع**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **المؤلف**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
