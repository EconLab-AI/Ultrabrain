...
📚 **[पूर्ण दस्तावेज़ीकरण देखें](https://docs.ultrabrain.ai/)** - आधिकारिक वेबसाइट पर ब्राउज़ करें

### शुरुआत करना

- **[इंस्टॉलेशन गाइड](https://docs.ultrabrain.ai/installation)** - त्वरित शुरुआत और उन्नत इंस्टॉलेशन
- **[उपयोग गाइड](https://docs.ultrabrain.ai/usage/getting-started)** - UltraBrain स्वचालित रूप से कैसे काम करता है
- **[खोज उपकरण](https://docs.ultrabrain.ai/usage/search-tools)** - प्राकृतिक भाषा के साथ अपने प्रोजेक्ट इतिहास को क्वेरी करें
- **[बीटा सुविधाएं](https://docs.ultrabrain.ai/beta-features)** - Endless Mode जैसी प्रायोगिक सुविधाओं को आज़माएं

### सर्वोत्तम अभ्यास

- **[संदर्भ इंजीनियरिंग](https://docs.ultrabrain.ai/context-engineering)** - AI एजेंट संदर्भ अनुकूलन सिद्धांत
- **[प्रगतिशील प्रकटीकरण](https://docs.ultrabrain.ai/progressive-disclosure)** - UltraBrain की संदर्भ प्राइमिंग रणनीति के पीछे का दर्शन

### आर्किटेक्चर

- **[अवलोकन](https://docs.ultrabrain.ai/architecture/overview)** - सिस्टम घटक और डेटा प्रवाह
- **[आर्किटेक्चर विकास](https://docs.ultrabrain.ai/architecture-evolution)** - v3 से v5 तक की यात्रा
- **[Hooks आर्किटेक्चर](https://docs.ultrabrain.ai/hooks-architecture)** - UltraBrain जीवनचक्र hooks का उपयोग कैसे करता है
- **[Hooks संदर्भ](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook स्क्रिप्ट समझाई गई
- **[Worker सेवा](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API और Bun प्रबंधन
- **[डेटाबेस](https://docs.ultrabrain.ai/architecture/database)** - SQLite स्कीमा और FTS5 खोज
- **[खोज आर्किटेक्चर](https://docs.ultrabrain.ai/architecture/search-architecture)** - Lance वेक्टर डेटाबेस के साथ हाइब्रिड खोज

### कॉन्फ़िगरेशन और विकास

- **[कॉन्फ़िगरेशन](https://docs.ultrabrain.ai/configuration)** - पर्यावरण चर और सेटिंग्स
- **[विकास](https://docs.ultrabrain.ai/development)** - बिल्डिंग, परीक्षण, योगदान
- **[समस्या निवारण](https://docs.ultrabrain.ai/troubleshooting)** - सामान्य समस्याएं और समाधान
...
6. **Lance वेक्टर डेटाबेस** - बुद्धिमान संदर्भ पुनर्प्राप्ति के लिए हाइब्रिड सिमेंटिक + कीवर्ड खोज

विवरण के लिए [आर्किटेक्चर अवलोकन](https://docs.ultrabrain.ai/architecture/overview) देखें।

---

## mem-search स्किल

UltraBrain mem-search स्किल के माध्यम से बुद्धिमान खोज प्रदान करता है जो स्वचालित रूप से सक्रिय हो जाती है जब आप पिछले काम के बारे में पूछते हैं:
...
विस्तृत उदाहरणों के लिए [खोज उपकरण गाइड](https://docs.ultrabrain.ai/usage/search-tools) देखें।

---

## बीटा सुविधाएं

UltraBrain **बीटा चैनल** के साथ **Endless Mode** (विस्तारित सत्रों के लिए बायोमिमेटिक मेमोरी आर्किटेक्चर) जैसी प्रायोगिक सुविधाएं प्रदान करता है। http://localhost:37777 → Settings पर वेब व्यूअर UI से स्थिर और बीटा संस्करणों के बीच स्विच करें।

Endless Mode के विवरण और इसे आज़माने के तरीके के लिए **[बीटा सुविधाएं दस्तावेज़ीकरण](https://docs.ultrabrain.ai/beta-features)** देखें।
...
सेटिंग्स `~/.ultrabrain/settings.json` में प्रबंधित की जाती हैं (पहली बार चलने पर डिफ़ॉल्ट के साथ ऑटो-निर्मित)। AI मॉडल, worker पोर्ट, डेटा डायरेक्टरी, लॉग स्तर, और संदर्भ इंजेक्शन सेटिंग्स कॉन्फ़िगर करें।

सभी उपलब्ध सेटिंग्स और उदाहरणों के लिए **[कॉन्फ़िगरेशन गाइड](https://docs.ultrabrain.ai/configuration)** देखें।

---

## विकास

बिल्ड निर्देश, परीक्षण, और योगदान वर्कफ़्लो के लिए **[विकास गाइड](https://docs.ultrabrain.ai/development)** देखें।
...
सामान्य समस्याओं और समाधानों के लिए **[समस्या निवारण गाइड](https://docs.ultrabrain.ai/troubleshooting)** देखें।
...
योगदान वर्कफ़्लो के लिए [विकास गाइड](https://docs.ultrabrain.ai/development) देखें।

---

## लाइसेंस

यह प्रोजेक्ट **MIT License** (MIT) के तहत लाइसेंस प्राप्त है।

Copyright (c) 2026 Giuliano Falco (@giulianofalco)। सर्वाधिकार सुरक्षित।
...
- व्युत्पन्न कार्यों को भी MIT के तहत लाइसेंस प्राप्त होना चाहिए
...
- **समस्याएं**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **रिपॉजिटरी**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **लेखक**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
