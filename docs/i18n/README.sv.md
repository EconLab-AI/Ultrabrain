...
📚 **[Visa fullständig dokumentation](https://docs.ultrabrain.ai/)** - Bläddra på den officiella webbplatsen

### Komma igång

- **[Installationsguide](https://docs.ultrabrain.ai/installation)** - Snabbstart och avancerad installation
- **[Användarguide](https://docs.ultrabrain.ai/usage/getting-started)** - Hur UltraBrain fungerar automatiskt
- **[Sökverktyg](https://docs.ultrabrain.ai/usage/search-tools)** - Sök i din projekthistorik med naturligt språk
- **[Betafunktioner](https://docs.ultrabrain.ai/beta-features)** - Testa experimentella funktioner som Endless Mode

### Bästa praxis

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - Optimeringsmetoder för AI-agentkontext
- **[Progressiv visning](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofin bakom UltraBrains kontextpriming-strategi

### Arkitektur

- **[Översikt](https://docs.ultrabrain.ai/architecture/overview)** - Systemkomponenter och dataflöde
- **[Arkitekturutveckling](https://docs.ultrabrain.ai/architecture-evolution)** - Resan från v3 till v5
- **[Hooks-arkitektur](https://docs.ultrabrain.ai/hooks-architecture)** - Hur UltraBrain använder livscykelkrokar
- **[Hooks-referens](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook-skript förklarade
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API och Bun-hantering
- **[Databas](https://docs.ultrabrain.ai/architecture/database)** - SQLite-schema och FTS5-sökning
- **[Sökarkitektur](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybridsökning med Chroma-vektordatabas

### Konfiguration och utveckling

- **[Konfiguration](https://docs.ultrabrain.ai/configuration)** - Miljövariabler och inställningar
- **[Utveckling](https://docs.ultrabrain.ai/development)** - Bygga, testa, bidra
- **[Felsökning](https://docs.ultrabrain.ai/troubleshooting)** - Vanliga problem och lösningar
...
Se [Arkitekturöversikt](https://docs.ultrabrain.ai/architecture/overview) för detaljer.

---

## mem-search-färdighet

UltraBrain tillhandahåller intelligent sökning genom mem-search-färdigheten som automatiskt aktiveras när du frågar om tidigare arbete:
...
Se [Sökverktygsguide](https://docs.ultrabrain.ai/usage/search-tools) för detaljerade exempel.

---

## Betafunktioner

UltraBrain erbjuder en **betakanal** med experimentella funktioner som **Endless Mode** (biomimetisk minnesarkitektur för utökade sessioner). Växla mellan stabila och betaversioner från webbvy-gränssnittet på http://localhost:37777 → Settings.

Se **[Dokumentation för betafunktioner](https://docs.ultrabrain.ai/beta-features)** för detaljer om Endless Mode och hur du testar det.
...
Inställningar hanteras i `~/.ultrabrain/settings.json` (skapas automatiskt med standardvärden vid första körning). Konfigurera AI-modell, worker-port, datakatalog, loggnivå och kontextinjektionsinställningar.

Se **[Konfigurationsguide](https://docs.ultrabrain.ai/configuration)** för alla tillgängliga inställningar och exempel.

---

## Utveckling

Se **[Utvecklingsguide](https://docs.ultrabrain.ai/development)** för bygginstruktioner, testning och bidragsarbetsflöde.
...
Se **[Felsökningsguide](https://docs.ultrabrain.ai/troubleshooting)** för vanliga problem och lösningar.
...
Se [Utvecklingsguide](https://docs.ultrabrain.ai/development) för bidragsarbetsflöde.
...
- **Problem**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Författare**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
