...
<p align="center">
  UltraBrain은 도구 사용 관찰을 자동으로 캡처하고 의미론적 요약을 생성하여 향후 세션에서 사용할 수 있도록 함으로써 세션 간 컨텍스트를 원활하게 보존합니다. 이를 통해 Claude는 세션이 종료되거나 재연결된 후에도 프로젝트에 대한 지식의 연속성을 유지할 수 있습니다.
</p>
...
📚 **[전체 문서 보기](https://docs.ultrabrain.ai/)** - 공식 웹사이트에서 찾아보기

### 시작하기

- **[설치 가이드](https://docs.ultrabrain.ai/installation)** - 빠른 시작 및 고급 설치
- **[사용 가이드](https://docs.ultrabrain.ai/usage/getting-started)** - UltraBrain이 자동으로 작동하는 방법
- **[검색 도구](https://docs.ultrabrain.ai/usage/search-tools)** - 자연어로 프로젝트 기록 쿼리
- **[베타 기능](https://docs.ultrabrain.ai/beta-features)** - Endless Mode와 같은 실험적 기능 시도

### 모범 사례

- **[컨텍스트 엔지니어링](https://docs.ultrabrain.ai/context-engineering)** - AI 에이전트 컨텍스트 최적화 원칙
- **[점진적 공개](https://docs.ultrabrain.ai/progressive-disclosure)** - UltraBrain의 컨텍스트 프라이밍 전략의 철학

### 아키텍처

- **[개요](https://docs.ultrabrain.ai/architecture/overview)** - 시스템 구성 요소 및 데이터 흐름
- **[아키텍처 진화](https://docs.ultrabrain.ai/architecture-evolution)** - v3에서 v5로의 여정
- **[후크 아키텍처](https://docs.ultrabrain.ai/hooks-architecture)** - UltraBrain이 라이프사이클 후크를 사용하는 방법
- **[후크 참조](https://docs.ultrabrain.ai/architecture/hooks)** - 7개 후크 스크립트 설명
- **[워커 서비스](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API 및 Bun 관리
- **[데이터베이스](https://docs.ultrabrain.ai/architecture/database)** - SQLite 스키마 및 FTS5 검색
- **[검색 아키텍처](https://docs.ultrabrain.ai/architecture/search-architecture)** - Lance 벡터 데이터베이스를 활용한 하이브리드 검색

### 설정 및 개발

- **[설정](https://docs.ultrabrain.ai/configuration)** - 환경 변수 및 설정
- **[개발](https://docs.ultrabrain.ai/development)** - 빌드, 테스트, 기여
- **[문제 해결](https://docs.ultrabrain.ai/troubleshooting)** - 일반적인 문제 및 해결 방법
...
6. **Lance 벡터 데이터베이스** - 지능형 컨텍스트 검색을 위한 하이브리드 의미론적 + 키워드 검색

자세한 내용은 [아키텍처 개요](https://docs.ultrabrain.ai/architecture/overview)를 참조하세요.

---

## mem-search 스킬

UltraBrain은 과거 작업에 대해 질문할 때 자동으로 호출되는 mem-search 스킬을 통해 지능형 검색을 제공합니다:
...
자세한 예제는 [검색 도구 가이드](https://docs.ultrabrain.ai/usage/search-tools)를 참조하세요.

---

## 베타 기능

UltraBrain은 **Endless Mode**(확장된 세션을 위한 생체모방 메모리 아키텍처)와 같은 실험적 기능을 제공하는 **베타 채널**을 제공합니다. http://localhost:37777 → Settings의 웹 뷰어 UI에서 안정 버전과 베타 버전 간 전환이 가능합니다.

Endless Mode 및 사용 방법에 대한 자세한 내용은 **[베타 기능 문서](https://docs.ultrabrain.ai/beta-features)**를 참조하세요.
...
설정은 `~/.ultrabrain/settings.json`에서 관리됩니다 (첫 실행 시 기본값으로 자동 생성). AI 모델, 워커 포트, 데이터 디렉토리, 로그 수준 및 컨텍스트 주입 설정을 구성할 수 있습니다.

사용 가능한 모든 설정 및 예제는 **[설정 가이드](https://docs.ultrabrain.ai/configuration)**를 참조하세요.

---

## 개발

빌드 지침, 테스트 및 기여 워크플로우는 **[개발 가이드](https://docs.ultrabrain.ai/development)**를 참조하세요.
...
일반적인 문제 및 해결 방법은 **[문제 해결 가이드](https://docs.ultrabrain.ai/troubleshooting)**를 참조하세요.
...
기여 워크플로우는 [개발 가이드](https://docs.ultrabrain.ai/development)를 참조하세요.

---

## 라이선스

이 프로젝트는 **MIT License** (MIT)에 따라 라이선스가 부여됩니다.
...
- 파생 작업물도 MIT에 따라 라이선스가 부여되어야 합니다
- 이 소프트웨어에는 보증이 없습니다
...
- **문서**: [docs/](docs/)
- **이슈**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **저장소**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **작성자**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
