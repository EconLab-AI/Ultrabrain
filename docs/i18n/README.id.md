...
<p align="center">
  UltraBrain secara mulus mempertahankan konteks di seluruh sesi dengan secara otomatis menangkap observasi penggunaan alat, menghasilkan ringkasan semantik, dan membuatnya tersedia untuk sesi mendatang. Ini memungkinkan Claude untuk mempertahankan kontinuitas pengetahuan tentang proyek bahkan setelah sesi berakhir atau tersambung kembali.
</p>
...
📚 **[Lihat Dokumentasi Lengkap](https://docs.ultrabrain.ai/)** - Jelajahi di situs web resmi

### Memulai

- **[Panduan Instalasi](https://docs.ultrabrain.ai/installation)** - Mulai cepat & instalasi lanjutan
- **[Panduan Penggunaan](https://docs.ultrabrain.ai/usage/getting-started)** - Bagaimana UltraBrain bekerja secara otomatis
- **[Alat Pencarian](https://docs.ultrabrain.ai/usage/search-tools)** - Query riwayat proyek Anda dengan bahasa alami
- **[Fitur Beta](https://docs.ultrabrain.ai/beta-features)** - Coba fitur eksperimental seperti Endless Mode

### Praktik Terbaik

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - Prinsip optimisasi konteks agen AI
- **[Progressive Disclosure](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofi di balik strategi priming konteks UltraBrain

### Arsitektur

- **[Ringkasan](https://docs.ultrabrain.ai/architecture/overview)** - Komponen sistem & aliran data
- **[Evolusi Arsitektur](https://docs.ultrabrain.ai/architecture-evolution)** - Perjalanan dari v3 ke v5
- **[Arsitektur Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Bagaimana UltraBrain menggunakan lifecycle hooks
- **[Referensi Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - 7 skrip hook dijelaskan
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API & manajemen Bun
- **[Database](https://docs.ultrabrain.ai/architecture/database)** - Skema SQLite & pencarian FTS5
- **[Arsitektur Pencarian](https://docs.ultrabrain.ai/architecture/search-architecture)** - Pencarian hybrid dengan database vektor Chroma

### Konfigurasi & Pengembangan

- **[Konfigurasi](https://docs.ultrabrain.ai/configuration)** - Variabel environment & pengaturan
- **[Pengembangan](https://docs.ultrabrain.ai/development)** - Membangun, testing, kontribusi
- **[Pemecahan Masalah](https://docs.ultrabrain.ai/troubleshooting)** - Masalah umum & solusi
...
6. **Lance Vector Database** - Pencarian hybrid semantik + keyword untuk pengambilan konteks yang cerdas

Lihat [Ringkasan Arsitektur](https://docs.ultrabrain.ai/architecture/overview) untuk detail.

---

## mem-search Skill

UltraBrain menyediakan pencarian cerdas melalui mem-search skill yang secara otomatis dipanggil saat Anda bertanya tentang pekerjaan masa lalu:
...
Lihat [Panduan Alat Pencarian](https://docs.ultrabrain.ai/usage/search-tools) untuk contoh detail.

---

## Fitur Beta

UltraBrain menawarkan **beta channel** dengan fitur eksperimental seperti **Endless Mode** (arsitektur memori biomimetik untuk sesi yang diperpanjang). Beralih antara versi stabil dan beta dari web viewer UI di http://localhost:37777 → Settings.

Lihat **[Dokumentasi Fitur Beta](https://docs.ultrabrain.ai/beta-features)** untuk detail tentang Endless Mode dan cara mencobanya.
...
Pengaturan dikelola di `~/.ultrabrain/settings.json` (otomatis dibuat dengan default saat pertama kali dijalankan). Konfigurasi model AI, port worker, direktori data, level log, dan pengaturan injeksi konteks.

Lihat **[Panduan Konfigurasi](https://docs.ultrabrain.ai/configuration)** untuk semua pengaturan dan contoh yang tersedia.

---

## Pengembangan

Lihat **[Panduan Pengembangan](https://docs.ultrabrain.ai/development)** untuk instruksi build, testing, dan alur kerja kontribusi.
...
Lihat **[Panduan Pemecahan Masalah](https://docs.ultrabrain.ai/troubleshooting)** untuk masalah umum dan solusi.
...
Lihat [Panduan Pengembangan](https://docs.ultrabrain.ai/development) untuk alur kerja kontribusi.
...
- **Repositori**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Penulis**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
