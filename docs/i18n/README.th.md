...
<p align="center">
  UltraBrain รักษาบริบทข้ามเซสชันได้อย่างราบรื่นโดยการบันทึกผลการสังเกตจากการใช้เครื่องมือโดยอัตโนมัติ สร้างสรุปความหมาย และทำให้พร้อมใช้งานสำหรับเซสชันในอนาคต ทำให้ Claude สามารถรักษาความต่อเนื่องของความรู้เกี่ยวกับโปรเจกต์แม้หลังจากเซสชันสิ้นสุดหรือเชื่อมต่อใหม่
</p>
...
📚 **[ดูเอกสารฉบับเต็ม](https://docs.ultrabrain.ai/)** - เรียกดูบนเว็บไซต์อย่างเป็นทางการ

### เริ่มต้นใช้งาน

- **[คู่มือการติดตั้ง](https://docs.ultrabrain.ai/installation)** - เริ่มต้นอย่างรวดเร็วและการติดตั้งขั้นสูง
- **[คู่มือการใช้งาน](https://docs.ultrabrain.ai/usage/getting-started)** - วิธีที่ UltraBrain ทำงานโดยอัตโนมัติ
- **[เครื่องมือค้นหา](https://docs.ultrabrain.ai/usage/search-tools)** - สืบค้นประวัติโปรเจกต์ของคุณด้วยภาษาธรรมชาติ
- **[คุณสมบัติ Beta](https://docs.ultrabrain.ai/beta-features)** - ลองคุณสมบัติทดลองเช่น Endless Mode

### แนวปฏิบัติที่ดี

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - หลักการปรับบริบทสำหรับเอเจนต์ AI
- **[Progressive Disclosure](https://docs.ultrabrain.ai/progressive-disclosure)** - ปรัชญาเบื้องหลังกลยุทธ์การเตรียมบริบทของ UltraBrain

### สถาปัตยกรรม

- **[ภาพรวม](https://docs.ultrabrain.ai/architecture/overview)** - ส่วนประกอบของระบบและการไหลของข้อมูล
- **[วิวัฒนาการของสถาปัตยกรรม](https://docs.ultrabrain.ai/architecture-evolution)** - การเดินทางจาก v3 สู่ v5
- **[สถาปัตยกรรม Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - วิธีที่ UltraBrain ใช้ lifecycle hooks
- **[การอ้างอิง Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - อธิบาย hook scripts ทั้ง 7 ตัว
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API และการจัดการ Bun
- **[ฐานข้อมูล](https://docs.ultrabrain.ai/architecture/database)** - SQLite schema และการค้นหา FTS5
- **[สถาปัตยกรรมการค้นหา](https://docs.ultrabrain.ai/architecture/search-architecture)** - การค้นหาแบบไฮบริดด้วยฐานข้อมูลเวกเตอร์ Chroma

### การกำหนดค่าและการพัฒนา

- **[การกำหนดค่า](https://docs.ultrabrain.ai/configuration)** - ตัวแปรสภาพแวดล้อมและการตั้งค่า
- **[การพัฒนา](https://docs.ultrabrain.ai/development)** - การสร้าง การทดสอบ การมีส่วนร่วม
- **[การแก้ไขปัญหา](https://docs.ultrabrain.ai/troubleshooting)** - ปัญหาและการแก้ไขทั่วไป
...
6. **Lance Vector Database** - การค้นหาแบบไฮบริดทางความหมาย + คีย์เวิร์ดสำหรับการดึงบริบทอัจฉริยะ

ดู [ภาพรวมสถาปัตยกรรม](https://docs.ultrabrain.ai/architecture/overview) สำหรับรายละเอียด

---

## ทักษะ mem-search

UltraBrain ให้บริการการค้นหาอัจฉริยะผ่านทักษะ mem-search ที่เรียกใช้อัตโนมัติเมื่อคุณถามเกี่ยวกับงานที่ผ่านมา:
...
ดู [คู่มือเครื่องมือค้นหา](https://docs.ultrabrain.ai/usage/search-tools) สำหรับตัวอย่างโดยละเอียด

---

## คุณสมบัติ Beta

UltraBrain นำเสนอ **beta channel** พร้อมคุณสมบัติทดลองเช่น **Endless Mode** (สถาปัตยกรรมหน่วยความจำแบบชีวมิติสำหรับเซสชันที่ขยายออกไป) สลับระหว่างเวอร์ชันเสถียรและเบต้าจาก web viewer UI ที่ http://localhost:37777 → Settings

ดู **[เอกสารคุณสมบัติ Beta](https://docs.ultrabrain.ai/beta-features)** สำหรับรายละเอียดเกี่ยวกับ Endless Mode และวิธีการลอง
...
การตั้งค่าจะถูกจัดการใน `~/.ultrabrain/settings.json` (สร้างอัตโนมัติพร้อมค่าเริ่มต้นในการรันครั้งแรก) กำหนดค่าโมเดล AI พอร์ต worker ไดเรกทอรีข้อมูล ระดับ log และการตั้งค่าการฉีดบริบท

ดู **[คู่มือการกำหนดค่า](https://docs.ultrabrain.ai/configuration)** สำหรับการตั้งค่าทั้งหมดที่มีและตัวอย่าง

---

## การพัฒนา

ดู **[คู่มือการพัฒนา](https://docs.ultrabrain.ai/development)** สำหรับคำแนะนำการสร้าง การทดสอบ และขั้นตอนการมีส่วนร่วม
...
ดู **[คู่มือการแก้ไขปัญหา](https://docs.ultrabrain.ai/troubleshooting)** สำหรับปัญหาและการแก้ไขทั่วไป
...
ดู [คู่มือการพัฒนา](https://docs.ultrabrain.ai/development) สำหรับขั้นตอนการมีส่วนร่วม

---

## ใบอนุญาต

โปรเจกต์นี้ได้รับอนุญาตภายใต้ **MIT License** (MIT)

Copyright (c) 2026 Giuliano Falco (@giulianofalco) สงวนลิขสิทธิ์ทั้งหมด
...
- งานที่เป็นอนุพันธ์ต้องได้รับอนุญาตภายใต้ MIT ด้วย
...
- **เอกสาร**: [docs/](docs/)
- **ปัญหา**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **ผู้เขียน**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
