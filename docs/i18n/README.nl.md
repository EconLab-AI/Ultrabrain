...
📚 **[Bekijk Volledige Documentatie](https://docs.ultrabrain.ai/)** - Bladeren op de officiële website

### Aan de Slag

- **[Installatiegids](https://docs.ultrabrain.ai/installation)** - Snel starten & geavanceerde installatie
- **[Gebruikersgids](https://docs.ultrabrain.ai/usage/getting-started)** - Hoe UltraBrain automatisch werkt
- **[Zoektools](https://docs.ultrabrain.ai/usage/search-tools)** - Bevraag je projectgeschiedenis met natuurlijke taal
- **[Bètafuncties](https://docs.ultrabrain.ai/beta-features)** - Probeer experimentele functies zoals Endless Mode

### Beste Praktijken

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - AI agent context optimalisatieprincipes
- **[Progressieve Onthulling](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofie achter UltraBrain's context priming strategie

### Architectuur

- **[Overzicht](https://docs.ultrabrain.ai/architecture/overview)** - Systeemcomponenten & gegevensstroom
- **[Architectuurevolutie](https://docs.ultrabrain.ai/architecture-evolution)** - De reis van v3 naar v5
- **[Hooks Architectuur](https://docs.ultrabrain.ai/hooks-architecture)** - Hoe UltraBrain lifecycle hooks gebruikt
- **[Hooks Referentie](https://docs.ultrabrain.ai/architecture/hooks)** - 7 hook scripts uitgelegd
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API & Bun beheer
- **[Database](https://docs.ultrabrain.ai/architecture/database)** - SQLite schema & FTS5 zoeken
- **[Zoekarchitectuur](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybride zoeken met Lance vector database

### Configuratie & Ontwikkeling

- **[Configuratie](https://docs.ultrabrain.ai/configuration)** - Omgevingsvariabelen & instellingen
- **[Ontwikkeling](https://docs.ultrabrain.ai/development)** - Bouwen, testen, bijdragen
- **[Probleemoplossing](https://docs.ultrabrain.ai/troubleshooting)** - Veelvoorkomende problemen & oplossingen
...
6. **Lance Vector Database** - Hybride semantisch + zoekwoord zoeken voor intelligente context ophaling

Zie [Architectuuroverzicht](https://docs.ultrabrain.ai/architecture/overview) voor details.

---

## mem-search Vaardigheid

UltraBrain biedt intelligent zoeken via de mem-search vaardigheid die automatisch wordt aangeroepen wanneer je vraagt over eerder werk:
...
Zie [Zoektools Gids](https://docs.ultrabrain.ai/usage/search-tools) voor gedetailleerde voorbeelden.

---

## Bètafuncties

UltraBrain biedt een **bètakanaal** met experimentele functies zoals **Endless Mode** (biomimetische geheugenarchitectuur voor uitgebreide sessies). Schakel tussen stabiele en bètaversies vanuit de web viewer UI op http://localhost:37777 → Settings.

Zie **[Bètafuncties Documentatie](https://docs.ultrabrain.ai/beta-features)** voor details over Endless Mode en hoe je het kunt proberen.
...
Instellingen worden beheerd in `~/.ultrabrain/settings.json` (automatisch aangemaakt met standaardinstellingen bij eerste run). Configureer AI model, worker poort, data directory, logniveau en context injectie-instellingen.

Zie de **[Configuratiegids](https://docs.ultrabrain.ai/configuration)** voor alle beschikbare instellingen en voorbeelden.

---

## Ontwikkeling

Zie de **[Ontwikkelingsgids](https://docs.ultrabrain.ai/development)** voor bouwinstructies, testen en bijdrageworkflow.
...
Zie de **[Probleemoplossingsgids](https://docs.ultrabrain.ai/troubleshooting)** voor veelvoorkomende problemen en oplossingen.
...
Zie [Ontwikkelingsgids](https://docs.ultrabrain.ai/development) voor bijdrageworkflow.

---

## Licentie

Dit project is gelicentieerd onder de **MIT License** (MIT).

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Alle rechten voorbehouden.
...
- Afgeleide werken moeten ook gelicentieerd zijn onder MIT
