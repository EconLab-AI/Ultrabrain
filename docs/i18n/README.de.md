...
<p align="center">
  UltraBrain bewahrt nahtlos Kontext über Sitzungen hinweg, indem es automatisch Beobachtungen zur Tool-Nutzung erfasst, semantische Zusammenfassungen generiert und diese für zukünftige Sitzungen verfügbar macht. Dies ermöglicht es Claude, die Kontinuität des Wissens über Projekte aufrechtzuerhalten, auch nachdem Sitzungen beendet wurden oder die Verbindung wiederhergestellt wird.
</p>
...
📚 **[Vollständige Dokumentation anzeigen](https://docs.ultrabrain.ai/)** - Auf der offiziellen Website durchsuchen

### Erste Schritte

- **[Installationsanleitung](https://docs.ultrabrain.ai/installation)** - Schnellstart & erweiterte Installation
- **[Nutzungsanleitung](https://docs.ultrabrain.ai/usage/getting-started)** - Wie UltraBrain automatisch funktioniert
- **[Suchwerkzeuge](https://docs.ultrabrain.ai/usage/search-tools)** - Durchsuchen Sie Ihre Projekthistorie mit natürlicher Sprache
- **[Beta-Funktionen](https://docs.ultrabrain.ai/beta-features)** - Probieren Sie experimentelle Funktionen wie den Endless Mode

### Best Practices

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - Prinzipien der Kontextoptimierung für KI-Agenten
- **[Progressive Disclosure](https://docs.ultrabrain.ai/progressive-disclosure)** - Philosophie hinter UltraBrains Kontext-Priming-Strategie

### Architektur

- **[Übersicht](https://docs.ultrabrain.ai/architecture/overview)** - Systemkomponenten & Datenfluss
- **[Architekturentwicklung](https://docs.ultrabrain.ai/architecture-evolution)** - Die Reise von v3 zu v5
- **[Hooks-Architektur](https://docs.ultrabrain.ai/hooks-architecture)** - Wie UltraBrain Lifecycle-Hooks verwendet
- **[Hooks-Referenz](https://docs.ultrabrain.ai/architecture/hooks)** - 7 Hook-Skripte erklärt
- **[Worker Service](https://docs.ultrabrain.ai/architecture/worker-service)** - HTTP API & Bun-Verwaltung
- **[Datenbank](https://docs.ultrabrain.ai/architecture/database)** - SQLite-Schema & FTS5-Suche
- **[Such-Architektur](https://docs.ultrabrain.ai/architecture/search-architecture)** - Hybride Suche mit Chroma-Vektordatenbank

### Konfiguration & Entwicklung

- **[Konfiguration](https://docs.ultrabrain.ai/configuration)** - Umgebungsvariablen & Einstellungen
- **[Entwicklung](https://docs.ultrabrain.ai/development)** - Erstellen, Testen, Beitragen
- **[Fehlerbehebung](https://docs.ultrabrain.ai/troubleshooting)** - Häufige Probleme & Lösungen
...
Siehe [Architekturübersicht](https://docs.ultrabrain.ai/architecture/overview) für Details.

---

## mem-search Skill

UltraBrain bietet intelligente Suche durch den mem-search Skill, der sich automatisch aktiviert, wenn Sie nach früheren Arbeiten fragen:
...
Siehe [Suchwerkzeuge-Anleitung](https://docs.ultrabrain.ai/usage/search-tools) für detaillierte Beispiele.

---

## Beta-Funktionen

UltraBrain bietet einen **Beta-Kanal** mit experimentellen Funktionen wie **Endless Mode** (biomimetische Speicherarchitektur für erweiterte Sitzungen). Wechseln Sie zwischen stabilen und Beta-Versionen über die Web-Viewer-UI unter http://localhost:37777 → Settings.

Siehe **[Beta-Funktionen-Dokumentation](https://docs.ultrabrain.ai/beta-features)** für Details zum Endless Mode und wie Sie ihn ausprobieren können.
...
Einstellungen werden in `~/.ultrabrain/settings.json` verwaltet (wird beim ersten Start automatisch mit Standardwerten erstellt). Konfigurieren Sie KI-Modell, Worker-Port, Datenverzeichnis, Log-Level und Kontext-Injektionseinstellungen.

Siehe die **[Konfigurationsanleitung](https://docs.ultrabrain.ai/configuration)** für alle verfügbaren Einstellungen und Beispiele.

---

## Entwicklung

Siehe die **[Entwicklungsanleitung](https://docs.ultrabrain.ai/development)** für Build-Anweisungen, Tests und Beitrags-Workflow.
...
Siehe die **[Fehlerbehebungsanleitung](https://docs.ultrabrain.ai/troubleshooting)** für häufige Probleme und Lösungen.
...
Siehe [Entwicklungsanleitung](https://docs.ultrabrain.ai/development) für den Beitrags-Workflow.

---

## Lizenz

Dieses Projekt ist unter der **MIT License** (MIT) lizenziert.

Copyright (c) 2026 Giuliano Falco (@giulianofalco). Alle Rechte vorbehalten.
...
- Abgeleitete Werke müssen ebenfalls unter MIT lizenziert werden
...
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
