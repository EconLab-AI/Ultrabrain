...
📚 **[Visualizza Documentazione Completa](https://docs.ultrabrain.ai/)** - Sfoglia sul sito ufficiale

### Per Iniziare

- **[Guida all'Installazione](https://docs.ultrabrain.ai/installation)** - Avvio rapido e installazione avanzata
- **[Guida all'Uso](https://docs.ultrabrain.ai/usage/getting-started)** - Come funziona automaticamente UltraBrain
- **[Strumenti di Ricerca](https://docs.ultrabrain.ai/usage/search-tools)** - Interroga la cronologia del progetto con linguaggio naturale
- **[Funzionalità Beta](https://docs.ultrabrain.ai/beta-features)** - Prova funzionalità sperimentali come Endless Mode

### Best Practice

- **[Context Engineering](https://docs.ultrabrain.ai/context-engineering)** - Principi di ottimizzazione del contesto per agenti AI
- **[Progressive Disclosure](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofia alla base della strategia di priming del contesto di UltraBrain

### Architettura

- **[Panoramica](https://docs.ultrabrain.ai/architecture/overview)** - Componenti del sistema e flusso dei dati
- **[Evoluzione dell'Architettura](https://docs.ultrabrain.ai/architecture-evolution)** - Il percorso dalla v3 alla v5
- **[Architettura degli Hook](https://docs.ultrabrain.ai/hooks-architecture)** - Come UltraBrain utilizza gli hook del ciclo di vita
- **[Riferimento Hook](https://docs.ultrabrain.ai/architecture/hooks)** - Spiegazione dei 7 script hook
- **[Servizio Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - API HTTP e gestione Bun
- **[Database](https://docs.ultrabrain.ai/architecture/database)** - Schema SQLite e ricerca FTS5
- **[Architettura di Ricerca](https://docs.ultrabrain.ai/architecture/search-architecture)** - Ricerca ibrida con database vettoriale Chroma

### Configurazione e Sviluppo

- **[Configurazione](https://docs.ultrabrain.ai/configuration)** - Variabili d'ambiente e impostazioni
- **[Sviluppo](https://docs.ultrabrain.ai/development)** - Build, test e flusso di contribuzione
- **[Risoluzione dei Problemi](https://docs.ultrabrain.ai/troubleshooting)** - Problemi comuni e soluzioni
...
Vedi [Panoramica dell'Architettura](https://docs.ultrabrain.ai/architecture/overview) per i dettagli.

---

## Skill mem-search

UltraBrain fornisce una ricerca intelligente tramite la skill mem-search che si attiva automaticamente quando chiedi del lavoro passato:
...
Vedi [Guida agli Strumenti di Ricerca](https://docs.ultrabrain.ai/usage/search-tools) per esempi dettagliati.

---

## Funzionalità Beta

UltraBrain offre un **canale beta** con funzionalità sperimentali come **Endless Mode** (architettura di memoria biomimetica per sessioni estese). Passa dalla versione stabile a quella beta dall'interfaccia web viewer su http://localhost:37777 → Settings.

Vedi **[Documentazione delle Funzionalità Beta](https://docs.ultrabrain.ai/beta-features)** per dettagli su Endless Mode e come provarlo.
...
Le impostazioni sono gestite in `~/.ultrabrain/settings.json` (creato automaticamente con valori predefiniti alla prima esecuzione). Configura il modello AI, la porta del worker, la directory dei dati, il livello di log e le impostazioni di iniezione del contesto.

Vedi la **[Guida alla Configurazione](https://docs.ultrabrain.ai/configuration)** per tutte le impostazioni disponibili ed esempi.

---

## Sviluppo

Vedi la **[Guida allo Sviluppo](https://docs.ultrabrain.ai/development)** per le istruzioni di build, test e flusso di contribuzione.
...
Vedi la **[Guida alla Risoluzione dei Problemi](https://docs.ultrabrain.ai/troubleshooting)** per problemi comuni e soluzioni.
...
Vedi [Guida allo Sviluppo](https://docs.ultrabrain.ai/development) per il flusso di contribuzione.
...
- **Problemi**: [GitHub Issues](https://github.com/EconLab-AI/Ultrabrain/issues)
- **Repository**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
- **Autore**: Giuliano Falco ([@giulianofalco](https://github.com/giulianofalco))
