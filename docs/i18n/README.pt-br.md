...
<p align="center">
  UltraBrain preserva o contexto perfeitamente entre sessões, capturando automaticamente observações de uso de ferramentas, gerando resumos semânticos e disponibilizando-os para sessões futuras. Isso permite que Claude mantenha a continuidade do conhecimento sobre projetos mesmo após o término ou reconexão de sessões.
</p>
...
📚 **[Ver Documentação Completa](https://docs.ultrabrain.ai/)** - Navegar no site oficial

### Começando

- **[Guia de Instalação](https://docs.ultrabrain.ai/installation)** - Início rápido e instalação avançada
- **[Guia de Uso](https://docs.ultrabrain.ai/usage/getting-started)** - Como UltraBrain funciona automaticamente
- **[Ferramentas de Busca](https://docs.ultrabrain.ai/usage/search-tools)** - Consulte seu histórico de projeto com linguagem natural
- **[Recursos Beta](https://docs.ultrabrain.ai/beta-features)** - Experimente recursos experimentais como o Endless Mode

### Melhores Práticas

- **[Engenharia de Contexto](https://docs.ultrabrain.ai/context-engineering)** - Princípios de otimização de contexto para agentes de IA
- **[Divulgação Progressiva](https://docs.ultrabrain.ai/progressive-disclosure)** - Filosofia por trás da estratégia de preparação de contexto do UltraBrain

### Arquitetura

- **[Visão Geral](https://docs.ultrabrain.ai/architecture/overview)** - Componentes do sistema e fluxo de dados
- **[Evolução da Arquitetura](https://docs.ultrabrain.ai/architecture-evolution)** - A jornada da v3 à v5
- **[Arquitetura de Hooks](https://docs.ultrabrain.ai/hooks-architecture)** - Como UltraBrain usa hooks de ciclo de vida
- **[Referência de Hooks](https://docs.ultrabrain.ai/architecture/hooks)** - 7 scripts de hook explicados
- **[Serviço Worker](https://docs.ultrabrain.ai/architecture/worker-service)** - API HTTP e gerenciamento do Bun
- **[Banco de Dados](https://docs.ultrabrain.ai/architecture/database)** - Schema SQLite e busca FTS5
- **[Arquitetura de Busca](https://docs.ultrabrain.ai/architecture/search-architecture)** - Busca híbrida com banco de dados vetorial Chroma

### Configuração e Desenvolvimento

- **[Configuração](https://docs.ultrabrain.ai/configuration)** - Variáveis de ambiente e configurações
- **[Desenvolvimento](https://docs.ultrabrain.ai/development)** - Build, testes e contribuição
- **[Solução de Problemas](https://docs.ultrabrain.ai/troubleshooting)** - Problemas comuns e soluções
...
Veja [Visão Geral da Arquitetura](https://docs.ultrabrain.ai/architecture/overview) para detalhes.

---

## Skill mem-search

UltraBrain fornece busca inteligente através da skill mem-search que se auto-invoca quando você pergunta sobre trabalhos anteriores:
...
Veja [Guia de Ferramentas de Busca](https://docs.ultrabrain.ai/usage/search-tools) para exemplos detalhados.

---

## Recursos Beta

UltraBrain oferece um **canal beta** com recursos experimentais como **Endless Mode** (arquitetura de memória biomimética para sessões estendidas). Alterne entre versões estável e beta pela interface de visualização web em http://localhost:37777 → Settings.

Veja **[Documentação de Recursos Beta](https://docs.ultrabrain.ai/beta-features)** para detalhes sobre o Endless Mode e como experimentá-lo.
...
As configurações são gerenciadas em `~/.ultrabrain/settings.json` (criado automaticamente com valores padrão na primeira execução). Configure modelo de IA, porta do worker, diretório de dados, nível de log e configurações de injeção de contexto.

Veja o **[Guia de Configuração](https://docs.ultrabrain.ai/configuration)** para todas as configurações disponíveis e exemplos.

---

## Desenvolvimento

Veja o **[Guia de Desenvolvimento](https://docs.ultrabrain.ai/development)** para instruções de build, testes e fluxo de contribuição.
...
Veja o **[Guia de Solução de Problemas](https://docs.ultrabrain.ai/troubleshooting)** para problemas comuns e soluções.
...
Veja [Guia de Desenvolvimento](https://docs.ultrabrain.ai/development) para o fluxo de contribuição.
...
Copyright (c) 2026 Giuliano Falco (@giulianofalco). Todos os direitos reservados.
...
- Trabalhos derivados também devem ser licenciados sob MIT
...
- **Repositório**: [github.com/EconLab-AI/Ultrabrain](https://github.com/EconLab-AI/Ultrabrain)
