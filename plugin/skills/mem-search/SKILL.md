---
name: mem-search
description: Search ultrabrain's persistent cross-session memory database. Use when user asks "did we already solve this?", "how did we do X last time?", or needs work from previous sessions.
---
...
- `project` (string, optional) - Project name, defaults to "ultrabrain"
